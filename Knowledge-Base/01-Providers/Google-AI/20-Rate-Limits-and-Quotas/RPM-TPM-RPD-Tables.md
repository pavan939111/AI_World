---
title: Google AI â€” RPM-TPM-RPD-Tables Specification
provider: Google AI
capability: 20-Rate-Limits-and-Quotas
file: RPM-TPM-RPD-Tables.md
last_updated: 2026-07-28
tags: [google, deepmind, 20-rate-limits-and-quotas, rpm-tpm-rpd-tables]
author: Antigravity AI Documentation Engine
---

# Google AI â€” RPM-TPM-RPD-Tables

## Overview
Detailed technical specification for **RPM-TPM-RPD-Tables** under **20-Rate-Limits-and-Quotas**.
