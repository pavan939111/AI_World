---
title: AWS Bedrock â€” InvokeModel-API Specification
provider: AWS Bedrock
capability: 08-APIs-and-Endpoints
file: InvokeModel-API.md
last_updated: 2026-07-28
tags: [aws-bedrock, amazon-nova, claude, 08-apis-and-endpoints, invokemodel-api]
author: Antigravity AI Documentation Engine
---

# AWS Bedrock â€” InvokeModel-API

## Overview
Detailed technical specification for **InvokeModel-API** under **08-APIs-and-Endpoints**.
