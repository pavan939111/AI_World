---
title: PlayHT â€” API-Usage-Billing Specification
provider: PlayHT
capability: 07-Pricing-and-Billing
file: API-Usage-Billing.md
last_updated: 2026-07-28
tags: [playht, tts, 07-pricing-and-billing, api-usage-billing]
author: Antigravity AI Documentation Engine
---

# PlayHT â€” API-Usage-Billing

## Overview
Detailed technical specification for **API-Usage-Billing** under **07-Pricing-and-Billing**.
