---
title: Groq â€” 01-Language-Models Overview
provider: Groq
capability: 01-Language-Models
last_updated: 2026-07-28
tags: [groq, lpu, 01-language-models]
author: Antigravity AI Documentation Engine
---

# Groq â€” 01-Language-Models

## 1. What This Capability Is
Ultra-fast open-weight foundation models running on Groq LPUs.

## 2. When to Use It
Comprehensive production guidance for when to select **01-Language-Models** on Groq LPU hardware for ultra-low latency AI applications.
