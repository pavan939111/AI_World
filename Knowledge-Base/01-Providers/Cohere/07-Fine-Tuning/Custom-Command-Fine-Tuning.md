---
title: Cohere â€” Custom-Command-Fine-Tuning Specification
provider: Cohere
capability: 07-Fine-Tuning
file: Custom-Command-Fine-Tuning.md
last_updated: 2026-07-28
tags: [cohere, command, rerank, 07-fine-tuning, custom-command-fine-tuning]
author: Antigravity AI Documentation Engine
---

# Cohere â€” Custom-Command-Fine-Tuning

## Overview
Detailed technical specification for **Custom-Command-Fine-Tuning** under **07-Fine-Tuning**.
