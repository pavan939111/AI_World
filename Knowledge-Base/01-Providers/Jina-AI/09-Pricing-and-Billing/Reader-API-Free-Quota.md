---
title: Jina AI â€” Reader-API-Free-Quota Specification
provider: Jina AI
capability: 09-Pricing-and-Billing
file: Reader-API-Free-Quota.md
last_updated: 2026-07-28
tags: [jina-ai, jina-embeddings-v3, 09-pricing-and-billing, reader-api-free-quota]
author: Antigravity AI Documentation Engine
---

# Jina AI â€” Reader-API-Free-Quota

## Overview
Detailed technical specification for **Reader-API-Free-Quota** under **09-Pricing-and-Billing**.
