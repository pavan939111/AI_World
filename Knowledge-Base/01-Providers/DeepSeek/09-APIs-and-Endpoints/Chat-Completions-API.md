---
title: DeepSeek â€” Chat-Completions-API Specification
provider: DeepSeek
capability: 09-APIs-and-Endpoints
file: Chat-Completions-API.md
last_updated: 2026-07-28
tags: [deepseek, deepseek-r1, deepseek-v3, 09-apis-and-endpoints, chat-completions-api]
author: Antigravity AI Documentation Engine
---

# DeepSeek â€” Chat-Completions-API

## Overview
Detailed technical specification for **Chat-Completions-API** under **09-APIs-and-Endpoints**.
