---
title: Cohere â€” Command-Light Specification
provider: Cohere
capability: 01-Language-Models
file: Command-Light.md
last_updated: 2026-07-28
tags: [cohere, command, rerank, 01-language-models, command-light]
author: Antigravity AI Documentation Engine
---

# Cohere â€” Command-Light

## Overview
Detailed technical specification for **Command-Light** under **01-Language-Models**.
