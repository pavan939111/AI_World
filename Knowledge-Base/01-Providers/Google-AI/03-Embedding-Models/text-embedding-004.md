---
title: Google AI â€” text-embedding-004 Specification
provider: Google AI
capability: 03-Embedding-Models
file: text-embedding-004.md
last_updated: 2026-07-28
tags: [google, deepmind, 03-embedding-models, text-embedding-004]
author: Antigravity AI Documentation Engine
---

# Google AI â€” text-embedding-004

## Overview
Detailed technical specification for **text-embedding-004** under **03-Embedding-Models**.
...
client = genai.Client()
print("Executing text-embedding-004 query...")
`
