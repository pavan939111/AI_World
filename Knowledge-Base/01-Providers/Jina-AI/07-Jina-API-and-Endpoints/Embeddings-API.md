---
title: Jina AI â€” Embeddings-API Specification
provider: Jina AI
capability: 07-Jina-API-and-Endpoints
file: Embeddings-API.md
last_updated: 2026-07-28
tags: [jina-ai, jina-embeddings-v3, 07-jina-api-and-endpoints, embeddings-api]
author: Antigravity AI Documentation Engine
---

# Jina AI â€” Embeddings-API

## Overview
Detailed technical specification for **Embeddings-API** under **07-Jina-API-and-Endpoints**.
