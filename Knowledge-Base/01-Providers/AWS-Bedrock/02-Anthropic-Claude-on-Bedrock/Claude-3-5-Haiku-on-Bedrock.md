---
title: AWS Bedrock â€” Claude-3-5-Haiku-on-Bedrock Specification
provider: AWS Bedrock
capability: 02-Anthropic-Claude-on-Bedrock
file: Claude-3-5-Haiku-on-Bedrock.md
last_updated: 2026-07-28
tags: [aws-bedrock, amazon-nova, claude, 02-anthropic-claude-on-bedrock, claude-3-5-haiku-on-bedrock]
author: Antigravity AI Documentation Engine
---

# AWS Bedrock â€” Claude-3-5-Haiku-on-Bedrock

## Overview
Detailed technical specification for **Claude-3-5-Haiku-on-Bedrock** under **02-Anthropic-Claude-on-Bedrock**.
