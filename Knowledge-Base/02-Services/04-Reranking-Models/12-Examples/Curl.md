---
title: Reranking Models â€” Curl
service: 04-Reranking-Models
section: 12-Examples
file: Curl.md
last_updated: 2026-07-28
tags: [reranking-models, cross-encoder, ndcg, 12-examples, curl]
...
## Executive Summary
Detailed technical breakdown of **Curl** within the **12-Examples** domain of Cross-Encoder Reranking Models & Two-Stage Information Retrieval.
...
## Detailed Analysis
1. **Technical Foundation**: How Curl computes full cross-attention between query and document text to dramatically outperform bi-encoder vector similarity on precision benchmarks.
2. **Production Application**: Best practices for implementing Curl in RAG pipelines to eliminate irrelevant context noise and reduce LLM prompt token costs.
