---
title: Jina AI â€” Reader-API-Specification Specification
provider: Jina AI
capability: 04-Web-Reader-and-Scraper-API
file: Reader-API-Specification.md
last_updated: 2026-07-28
tags: [jina-ai, jina-embeddings-v3, 04-web-reader-and-scraper-api, reader-api-specification]
author: Antigravity AI Documentation Engine
---

# Jina AI â€” Reader-API-Specification

## Overview
Detailed technical specification for **Reader-API-Specification** under **04-Web-Reader-and-Scraper-API**.
