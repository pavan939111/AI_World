---
title: Runway â€” Lip-Sync-Video-API Specification
provider: Runway
capability: 06-Audio-and-Voice-Synthesis
file: Lip-Sync-Video-API.md
last_updated: 2026-07-28
tags: [runway, gen-3-alpha, 06-audio-and-voice-synthesis, lip-sync-video-api]
author: Antigravity AI Documentation Engine
---

# Runway â€” Lip-Sync-Video-API

## Overview
Detailed technical specification for **Lip-Sync-Video-API** under **06-Audio-and-Voice-Synthesis**.
