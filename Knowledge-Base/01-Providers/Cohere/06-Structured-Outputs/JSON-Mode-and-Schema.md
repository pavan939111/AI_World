---
title: Cohere â€” JSON-Mode-and-Schema Specification
provider: Cohere
capability: 06-Structured-Outputs
file: JSON-Mode-and-Schema.md
last_updated: 2026-07-28
tags: [cohere, command, rerank, 06-structured-outputs, json-mode-and-schema]
author: Antigravity AI Documentation Engine
---

# Cohere â€” JSON-Mode-and-Schema

## Overview
Detailed technical specification for **JSON-Mode-and-Schema** under **06-Structured-Outputs**.
