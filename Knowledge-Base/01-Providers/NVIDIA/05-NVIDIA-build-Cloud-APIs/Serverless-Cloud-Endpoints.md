---
title: NVIDIA AI â€” Serverless-Cloud-Endpoints Specification
provider: NVIDIA
capability: 05-NVIDIA-build-Cloud-APIs
file: Serverless-Cloud-Endpoints.md
last_updated: 2026-07-28
tags: [nvidia, nim, nemotron, 05-nvidia-build-cloud-apis, serverless-cloud-endpoints]
author: Antigravity AI Documentation Engine
---

# NVIDIA AI â€” Serverless-Cloud-Endpoints

## Overview
Detailed technical specification for **Serverless-Cloud-Endpoints** under **05-NVIDIA-build-Cloud-APIs**.
