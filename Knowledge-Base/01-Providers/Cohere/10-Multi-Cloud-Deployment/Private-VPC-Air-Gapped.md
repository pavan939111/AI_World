---
title: Cohere â€” Private-VPC-Air-Gapped Specification
provider: Cohere
capability: 10-Multi-Cloud-Deployment
file: Private-VPC-Air-Gapped.md
last_updated: 2026-07-28
tags: [cohere, command, rerank, 10-multi-cloud-deployment, private-vpc-air-gapped]
author: Antigravity AI Documentation Engine
---

# Cohere â€” Private-VPC-Air-Gapped

## Overview
Detailed technical specification for **Private-VPC-Air-Gapped** under **10-Multi-Cloud-Deployment**.
