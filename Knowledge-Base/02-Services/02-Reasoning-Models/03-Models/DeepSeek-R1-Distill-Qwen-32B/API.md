---
title: DeepSeek-R1-Distill-Qwen-32B â€” Puzzle-and-Riddle-Solving
service: 02-Reasoning-Models
model: DeepSeek-R1-Distill-Qwen-32B
section: 03-Models
file: API.md
last_updated: 2026-07-28
tags: [reasoning-models, deepseek-r1-distill-qwen-32b, puzzle-and-riddle-solving]
author: Antigravity AI Knowledge Engine
---

# DeepSeek-R1-Distill-Qwen-32B â€” Puzzle-and-Riddle-Solving

## Model Specification: DeepSeek-R1-Distill-Qwen-32B
...
## Code Example (DeepSeek-R1-Distill-Qwen-32B Request)
`python
import os
