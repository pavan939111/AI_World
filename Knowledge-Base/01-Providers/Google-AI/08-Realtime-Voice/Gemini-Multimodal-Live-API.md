---
title: Google AI â€” Gemini-Multimodal-Live-API Specification
provider: Google AI
capability: 08-Realtime-Voice
file: Gemini-Multimodal-Live-API.md
last_updated: 2026-07-28
tags: [google, deepmind, 08-realtime-voice, gemini-multimodal-live-api]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Gemini-Multimodal-Live-API

## Overview
Detailed technical specification for **Gemini-Multimodal-Live-API** under **08-Realtime-Voice**.
...
client = genai.Client()
print("Executing Gemini-Multimodal-Live-API query...")
`
