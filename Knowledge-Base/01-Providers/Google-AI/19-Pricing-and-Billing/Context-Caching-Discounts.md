---
title: Google AI â€” Context-Caching-Discounts Specification
provider: Google AI
capability: 19-Pricing-and-Billing
file: Context-Caching-Discounts.md
last_updated: 2026-07-28
tags: [google, deepmind, 19-pricing-and-billing, context-caching-discounts]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Context-Caching-Discounts

## Overview
Detailed technical specification for **Context-Caching-Discounts** under **19-Pricing-and-Billing**.
...
client = genai.Client()
print("Executing Context-Caching-Discounts query...")
`
