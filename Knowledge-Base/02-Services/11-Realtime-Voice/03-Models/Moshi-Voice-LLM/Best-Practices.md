---
title: Moshi-Voice-LLM â€” Best-Practices
service: 11-Realtime-Voice
model: Moshi-Voice-LLM
section: 03-Models
file: Best-Practices.md
last_updated: 2026-07-28
tags: [realtime-voice, moshi-voice-llm, best-practices]
author: Antigravity AI Knowledge Engine
---

# Moshi-Voice-LLM â€” Best-Practices

## Model Specification: Moshi-Voice-LLM
- **Model Name**: Moshi-Voice-LLM
...
## Code Example (Moshi-Voice-LLM API Request)
`javascript
...
ws.onopen = () => {
  ws.send(JSON.stringify({
    type: "session.update",
    session: { model: "moshi-voice-llm", voice: "natural_voice_1" }
  }));
};
`
