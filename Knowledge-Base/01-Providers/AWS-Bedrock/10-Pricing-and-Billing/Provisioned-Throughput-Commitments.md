---
title: AWS Bedrock â€” Provisioned-Throughput-Commitments Specification
provider: AWS Bedrock
capability: 10-Pricing-and-Billing
file: Provisioned-Throughput-Commitments.md
last_updated: 2026-07-28
tags: [aws-bedrock, amazon-nova, claude, 10-pricing-and-billing, provisioned-throughput-commitments]
author: Antigravity AI Documentation Engine
---

# AWS Bedrock â€” Provisioned-Throughput-Commitments

## Overview
Detailed technical specification for **Provisioned-Throughput-Commitments** under **10-Pricing-and-Billing**.
