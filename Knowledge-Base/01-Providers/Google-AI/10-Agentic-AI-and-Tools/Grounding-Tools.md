---
title: Google AI â€” Grounding-Tools Specification
provider: Google AI
capability: 10-Agentic-AI-and-Tools
file: Grounding-Tools.md
last_updated: 2026-07-28
tags: [google, deepmind, 10-agentic-ai-and-tools, grounding-tools]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Grounding-Tools

## Overview
Detailed technical specification for **Grounding-Tools** under **10-Agentic-AI-and-Tools**.
...
client = genai.Client()
print("Executing Grounding-Tools query...")
`
