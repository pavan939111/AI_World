---
title: DeepSeek â€” DeepSeek-R1-Local-Ollama-RAG Specification
provider: DeepSeek
capability: 14-Architectures-and-Examples
file: DeepSeek-R1-Local-Ollama-RAG.md
last_updated: 2026-07-28
tags: [deepseek, deepseek-r1, deepseek-v3, 14-architectures-and-examples, deepseek-r1-local-ollama-rag]
author: Antigravity AI Documentation Engine
---

# DeepSeek â€” DeepSeek-R1-Local-Ollama-RAG

## Overview
Detailed technical specification for **DeepSeek-R1-Local-Ollama-RAG** under **14-Architectures-and-Examples**.
