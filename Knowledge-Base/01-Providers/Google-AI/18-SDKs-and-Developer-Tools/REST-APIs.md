---
title: Google AI â€” REST-APIs Specification
provider: Google AI
capability: 18-SDKs-and-Developer-Tools
file: REST-APIs.md
last_updated: 2026-07-28
tags: [google, deepmind, 18-sdks-and-developer-tools, rest-apis]
author: Antigravity AI Documentation Engine
---

# Google AI â€” REST-APIs

## Overview
Detailed technical specification for **REST-APIs** under **18-SDKs-and-Developer-Tools**.
...
client = genai.Client()
print("Executing REST-APIs query...")
`
