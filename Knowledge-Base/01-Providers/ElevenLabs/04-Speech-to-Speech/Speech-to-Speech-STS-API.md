---
title: ElevenLabs â€” Speech-to-Speech-STS-API Specification
provider: ElevenLabs
capability: 04-Speech-to-Speech
file: Speech-to-Speech-STS-API.md
last_updated: 2026-07-28
tags: [elevenlabs, tts, 04-speech-to-speech, speech-to-speech-sts-api]
author: Antigravity AI Documentation Engine
---

# ElevenLabs â€” Speech-to-Speech-STS-API

## Overview
Detailed technical specification for **Speech-to-Speech-STS-API** under **04-Speech-to-Speech**.
