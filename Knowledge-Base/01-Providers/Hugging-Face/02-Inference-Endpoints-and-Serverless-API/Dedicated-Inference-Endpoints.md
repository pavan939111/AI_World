---
title: Hugging Face â€” Dedicated-Inference-Endpoints Specification
provider: Hugging Face
capability: 02-Inference-Endpoints-and-Serverless-API
file: Dedicated-Inference-Endpoints.md
last_updated: 2026-07-28
tags: [hugging-face, transformers, 02-inference-endpoints-and-serverless-api, dedicated-inference-endpoints]
author: Antigravity AI Documentation Engine
---

# Hugging Face â€” Dedicated-Inference-Endpoints

## Overview
Detailed technical specification for **Dedicated-Inference-Endpoints** under **02-Inference-Endpoints-and-Serverless-API**.
