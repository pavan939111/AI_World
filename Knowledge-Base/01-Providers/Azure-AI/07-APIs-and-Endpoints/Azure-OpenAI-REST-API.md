---
title: Azure AI â€” Azure-OpenAI-REST-API Specification
provider: Azure AI
capability: 07-APIs-and-Endpoints
file: Azure-OpenAI-REST-API.md
last_updated: 2026-07-28
tags: [azure-ai, azure-openai, 07-apis-and-endpoints, azure-openai-rest-api]
author: Antigravity AI Documentation Engine
---

# Azure AI â€” Azure-OpenAI-REST-API

## Overview
Detailed technical specification for **Azure-OpenAI-REST-API** under **07-APIs-and-Endpoints**.
