---
title: Reranking Models â€” Cost-per-100k-Tokens
service: 04-Reranking-Models
section: 13-Benchmarks
file: Cost-per-100k-Tokens.md
last_updated: 2026-07-28
tags: [reranking-models, cross-encoder, ndcg, 13-benchmarks, cost-per-100k-tokens]
...
## Executive Summary
Detailed technical breakdown of **Cost-per-100k-Tokens** within the **13-Benchmarks** domain of Cross-Encoder Reranking Models & Two-Stage Information Retrieval.
...
## Detailed Analysis
1. **Technical Foundation**: How Cost-per-100k-Tokens computes full cross-attention between query and document text to dramatically outperform bi-encoder vector similarity on precision benchmarks.
2. **Production Application**: Best practices for implementing Cost-per-100k-Tokens in RAG pipelines to eliminate irrelevant context noise and reduce LLM prompt token costs.
