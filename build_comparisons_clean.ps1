...
foreach ($cat in $categories.Keys) {
    ...
    foreach ($f in $categories[$cat]) {
        ...
        $cTxt = @"
---
title: $fName — Decision & Selection Guide
...
# $fName — Decision & Selection Guide

## Executive Core Question
> **"Given my technical and financial requirements, what should I choose for $fName?"**

## Selection Framework & Evaluation Criteria
When evaluating options within **$fName**, decisions are grounded in 5 core dimensions:
