---
title: Anthropic â€” Claude-Code-CLI Specification
provider: Anthropic
capability: 13-SDKs-and-Developer-Tools
file: Claude-Code-CLI.md
last_updated: 2026-07-28
tags: [anthropic, claude, 13-sdks-and-developer-tools, claude-code-cli]
...
## Overview
Detailed technical specification for **Claude-Code-CLI** under **13-SDKs-and-Developer-Tools**.
...
print("Executing Claude-Code-CLI query...")
`
