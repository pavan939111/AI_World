---
title: Meta AI â€” 09-Structured-Outputs Overview
provider: Meta
capability: 09-Structured-Outputs
last_updated: 2026-07-28
tags: [meta, llama, open-source, 09-structured-outputs]
author: Antigravity AI Documentation Engine
---

# Meta AI â€” 09-Structured-Outputs

## 1. What This Capability Is
JSON mode and schema enforcement for Llama.

## 2. When to Use It
Comprehensive production guidance for when to select **09-Structured-Outputs** in Meta Llama open-source applications.
