---
title: Together AI â€” LoRA-Adaptation Specification
provider: Together AI
capability: 05-Custom-Fine-Tuning-API
file: LoRA-Adaptation.md
last_updated: 2026-07-28
tags: [together-ai, llama, deepseek, 05-custom-fine-tuning-api, lora-adaptation]
author: Antigravity AI Documentation Engine
---

# Together AI â€” LoRA-Adaptation

## Overview
Detailed technical specification for **LoRA-Adaptation** under **05-Custom-Fine-Tuning-API**.
