---
title: Google AI â€” Node-TypeScript-SDK Specification
provider: Google AI
capability: 18-SDKs-and-Developer-Tools
file: Node-TypeScript-SDK.md
last_updated: 2026-07-28
tags: [google, deepmind, 18-sdks-and-developer-tools, node-typescript-sdk]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Node-TypeScript-SDK

## Overview
Detailed technical specification for **Node-TypeScript-SDK** under **18-SDKs-and-Developer-Tools**.
...
client = genai.Client()
print("Executing Node-TypeScript-SDK query...")
`
