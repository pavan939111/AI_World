---
title: Ideogram â€” 06-Color-Palette-Control Overview
provider: Ideogram
capability: 06-Color-Palette-Control
last_updated: 2026-07-28
tags: [ideogram, typography, image-generation, 06-color-palette-control]
author: Antigravity AI Documentation Engine
---

# Ideogram â€” 06-Color-Palette-Control

## 1. What This Capability Is
Brand color palette enforcement.

## 2. When to Use It
Comprehensive production guidance for when to select **06-Color-Palette-Control** in Ideogram image generation applications.
