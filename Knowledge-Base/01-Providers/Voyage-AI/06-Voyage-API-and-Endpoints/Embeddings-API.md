---
title: Voyage AI â€” Embeddings-API Specification
provider: Voyage AI
capability: 06-Voyage-API-and-Endpoints
file: Embeddings-API.md
last_updated: 2026-07-28
tags: [voyage-ai, voyage-3, 06-voyage-api-and-endpoints, embeddings-api]
author: Antigravity AI Documentation Engine
---

# Voyage AI â€” Embeddings-API

## Overview
Detailed technical specification for **Embeddings-API** under **06-Voyage-API-and-Endpoints**.
