---
title: OpenAI â€” Usage-Tiers-1-to-5 Specification
provider: OpenAI
capability: 17-Rate-Limits-and-Quotas
file: Usage-Tiers-1-to-5.md
last_updated: 2026-07-28
tags: [openai, 17-rate-limits-and-quotas, usage-tiers-1-to-5]
author: Antigravity AI Documentation Engine
---

# OpenAI â€” Usage-Tiers-1-to-5

## Overview
Detailed technical specification for **Usage-Tiers-1-to-5** under **17-Rate-Limits-and-Quotas**.
...
client = OpenAI()
print("Executing Usage-Tiers-1-to-5 query...")
`
