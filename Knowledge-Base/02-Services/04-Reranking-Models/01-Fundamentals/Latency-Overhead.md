---
title: Reranking Models â€” Latency-Overhead
service: 04-Reranking-Models
section: 01-Fundamentals
file: Latency-Overhead.md
last_updated: 2026-07-28
tags: [reranking-models, cross-encoder, ndcg, 01-fundamentals, latency-overhead]
...
## Executive Summary
Detailed technical breakdown of **Latency-Overhead** within the **01-Fundamentals** domain of Cross-Encoder Reranking Models & Two-Stage Information Retrieval.
...
## Detailed Analysis
1. **Technical Foundation**: How Latency-Overhead computes full cross-attention between query and document text to dramatically outperform bi-encoder vector similarity on precision benchmarks.
2. **Production Application**: Best practices for implementing Latency-Overhead in RAG pipelines to eliminate irrelevant context noise and reduce LLM prompt token costs.
