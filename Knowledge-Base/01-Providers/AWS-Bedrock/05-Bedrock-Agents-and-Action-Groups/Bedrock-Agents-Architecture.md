---
title: AWS Bedrock â€” Bedrock-Agents-Architecture Specification
provider: AWS Bedrock
capability: 05-Bedrock-Agents-and-Action-Groups
file: Bedrock-Agents-Architecture.md
last_updated: 2026-07-28
tags: [aws-bedrock, amazon-nova, claude, 05-bedrock-agents-and-action-groups, bedrock-agents-architecture]
author: Antigravity AI Documentation Engine
---

# AWS Bedrock â€” Bedrock-Agents-Architecture

## Overview
Detailed technical specification for **Bedrock-Agents-Architecture** under **05-Bedrock-Agents-and-Action-Groups**.
