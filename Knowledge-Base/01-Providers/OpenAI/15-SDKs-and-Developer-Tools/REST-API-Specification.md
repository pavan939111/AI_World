---
title: OpenAI â€” REST-API-Specification Specification
provider: OpenAI
capability: 15-SDKs-and-Developer-Tools
file: REST-API-Specification.md
last_updated: 2026-07-28
tags: [openai, 15-sdks-and-developer-tools, rest-api-specification]
author: Antigravity AI Documentation Engine
---

# OpenAI â€” REST-API-Specification

## Overview
Detailed technical specification for **REST-API-Specification** under **15-SDKs-and-Developer-Tools**.
...
client = OpenAI()
print("Executing REST-API-Specification query...")
`
