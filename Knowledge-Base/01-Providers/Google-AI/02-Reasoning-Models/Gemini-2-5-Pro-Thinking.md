---
title: Google AI â€” Gemini-2-5-Pro-Thinking Specification
provider: Google AI
capability: 02-Reasoning-Models
file: Gemini-2-5-Pro-Thinking.md
last_updated: 2026-07-28
tags: [google, deepmind, 02-reasoning-models, gemini-2-5-pro-thinking]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Gemini-2-5-Pro-Thinking

## Overview
Detailed technical specification for **Gemini-2-5-Pro-Thinking** under **02-Reasoning-Models**.
...
client = genai.Client()
print("Executing Gemini-2-5-Pro-Thinking query...")
`
