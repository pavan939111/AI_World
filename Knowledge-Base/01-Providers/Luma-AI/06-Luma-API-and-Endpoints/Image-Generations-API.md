---
title: Luma AI â€” Image-Generations-API Specification
provider: Luma AI
capability: 06-Luma-API-and-Endpoints
file: Image-Generations-API.md
last_updated: 2026-07-28
tags: [luma-ai, dream-machine, 06-luma-api-and-endpoints, image-generations-api]
author: Antigravity AI Documentation Engine
---

# Luma AI â€” Image-Generations-API

## Overview
Detailed technical specification for **Image-Generations-API** under **06-Luma-API-and-Endpoints**.
