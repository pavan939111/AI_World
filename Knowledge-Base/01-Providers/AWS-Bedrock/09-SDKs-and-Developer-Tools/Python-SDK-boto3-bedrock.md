---
title: AWS Bedrock â€” Python-SDK-boto3-bedrock Specification
provider: AWS Bedrock
capability: 09-SDKs-and-Developer-Tools
file: Python-SDK-boto3-bedrock.md
last_updated: 2026-07-28
tags: [aws-bedrock, amazon-nova, claude, 09-sdks-and-developer-tools, python-sdk-boto3-bedrock]
author: Antigravity AI Documentation Engine
---

# AWS Bedrock â€” Python-SDK-boto3-bedrock

## Overview
Detailed technical specification for **Python-SDK-boto3-bedrock** under **09-SDKs-and-Developer-Tools**.
