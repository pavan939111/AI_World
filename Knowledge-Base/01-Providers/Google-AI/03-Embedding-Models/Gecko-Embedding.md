---
title: Google AI â€” Gecko-Embedding Specification
provider: Google AI
capability: 03-Embedding-Models
file: Gecko-Embedding.md
last_updated: 2026-07-28
tags: [google, deepmind, 03-embedding-models, gecko-embedding]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Gecko-Embedding

## Overview
Detailed technical specification for **Gecko-Embedding** under **03-Embedding-Models**.
...
client = genai.Client()
print("Executing Gecko-Embedding query...")
`
