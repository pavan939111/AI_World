---
title: Realtime Voice â€” Moshi-Kyutai-Full-Duplex
service: 11-Realtime-Voice
section: 10-Open-Source
file: Moshi-Kyutai-Full-Duplex.md
last_updated: 2026-07-28
tags: [realtime-voice, speech-to-speech, webrtc, 10-open-source, moshi-kyutai-full-duplex]
author: Antigravity AI Knowledge Engine
---

# Moshi-Kyutai-Full-Duplex

## Executive Summary
Detailed technical breakdown of **Moshi-Kyutai-Full-Duplex** within the **10-Open-Source** domain of Realtime Full-Duplex Speech-to-Speech AI, WebRTC Voice Engines, and Conversational Voice Agents.
...
## Detailed Analysis
1. **Technical Foundation**: How Moshi-Kyutai-Full-Duplex manages WebRTC peer connections, server-side audio frame buffering, G.711 u-law / Opus codec encoding, function calling over active audio sessions, and session event loops.
2. **Production Application**: Best practices for integrating Moshi-Kyutai-Full-Duplex into enterprise telephony customer service agents (Twilio/Telnyx SIP), real-time language interpreters, and interactive AI voice concierges.
