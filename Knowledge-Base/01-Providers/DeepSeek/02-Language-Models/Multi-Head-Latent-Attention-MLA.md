---
title: DeepSeek â€” Multi-Head-Latent-Attention-MLA Specification
provider: DeepSeek
capability: 02-Language-Models
file: Multi-Head-Latent-Attention-MLA.md
last_updated: 2026-07-28
tags: [deepseek, deepseek-r1, deepseek-v3, 02-language-models, multi-head-latent-attention-mla]
author: Antigravity AI Documentation Engine
---

# DeepSeek â€” Multi-Head-Latent-Attention-MLA

## Overview
Detailed technical specification for **Multi-Head-Latent-Attention-MLA** under **02-Language-Models**.
