---
title: Replicate â€” Qwen-2-5-72B-Replicate Specification
provider: Replicate
capability: 03-Open-Language-and-Reasoning-Models
file: Qwen-2-5-72B-Replicate.md
last_updated: 2026-07-28
tags: [replicate, cog, 03-open-language-and-reasoning-models, qwen-2-5-72b-replicate]
author: Antigravity AI Documentation Engine
---

# Replicate â€” Qwen-2-5-72B-Replicate

## Overview
Detailed technical specification for **Qwen-2-5-72B-Replicate** under **03-Open-Language-and-Reasoning-Models**.
