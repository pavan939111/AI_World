---
title: Google AI â€” Safety-Settings-API Specification
provider: Google AI
capability: 16-Safety-and-Moderation
file: Safety-Settings-API.md
last_updated: 2026-07-28
tags: [google, deepmind, 16-safety-and-moderation, safety-settings-api]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Safety-Settings-API

## Overview
Detailed technical specification for **Safety-Settings-API** under **16-Safety-and-Moderation**.
...
client = genai.Client()
print("Executing Safety-Settings-API query...")
`
