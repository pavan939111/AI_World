$baseDir = "c:\Users\Admin\Desktop\AI_World\Knowledge-Base\03-Comparisons"
...
$categories = @{
    "00-Selection-Criteria" = @("Cost.md", "Accuracy.md", "Latency.md", "Reliability.md", "Context-Window.md", "Multimodal-Support.md", "Fine-Tuning-Support.md", "API-Quality.md", "SDK-Support.md", "Enterprise-Features.md", "Privacy-and-Security.md", "Licensing.md", "Ease-of-Integration.md");
    "01-Model-Comparisons" = @("GPT-4o-vs-Claude.md", "GPT-Image-vs-FLUX.md", "Imagen-vs-GPT-Image.md", "Gemini-vs-GPT-4o.md", "Embedding-Models.md", "Speech-Models.md", "Video-Models.md");
    "02-Provider-Comparisons" = @("OpenAI-vs-Google.md", "Anthropic-vs-OpenAI.md", "OpenAI-vs-xAI.md", "AWS-vs-Azure-vs-Vertex-AI.md", "Open-source-Providers.md", "Enterprise-Providers.md");
    "03-Service-Comparisons" = @("Image-Generation.md", "Video-Generation.md", "Speech.md", "Embeddings.md", "Fine-tuning.md", "Agents.md", "Vision.md");
    "04-Pricing" = @("Cheapest-LLMs.md", "Cheapest-Image-APIs.md", "Cheapest-Embeddings.md", "Enterprise-Pricing.md", "Free-Tiers.md", "Cost-Calculators.md");
    "05-Benchmarks" = @("LLM-Benchmarks.md", "Image-Benchmarks.md", "Coding-Benchmarks.md", "Vision-Benchmarks.md", "Speech-Benchmarks.md", "Agent-Benchmarks.md");
    "06-Performance" = @("Fastest-Models.md", "Lowest-Latency.md", "Highest-Throughput.md", "Largest-Context-Windows.md", "Memory-Usage.md", "Inference-Costs.md");
    "07-Use-Case-Guides" = @("Startup-MVP.md", "Enterprise-Chatbot.md", "AI-Agent.md", "Customer-Support.md", "Code-Assistant.md", "Content-Creation.md", "Research-Assistant.md", "Mobile-Apps.md", "RAG-Systems.md", "Education.md", "Healthcare.md", "Finance.md");
    "08-Architecture-Decisions" = @("Choosing-an-LLM.md", "Choosing-Embeddings.md", "Choosing-a-Vector-Database.md", "Choosing-an-Agent-Framework.md", "Hosted-vs-Self-hosted.md", "Multi-model-Systems.md", "Hybrid-Architectures.md");
    "09-Open-Source-vs-Hosted" = @("LLMs.md", "Image-Models.md", "Speech-Models.md", "Vector-Databases.md", "Deployment-Comparison.md");
    "10-Decision-Trees" = @("Which-LLM-Should-I-Use.md", "Which-Image-Model.md", "Which-Embedding-Model.md", "Which-Speech-Model.md", "Which-Provider.md", "Which-Fine-Tuning-Method.md");
    "11-Market-Trends" = @("New-Releases.md", "Deprecations.md", "Emerging-Providers.md", "Industry-Reports.md", "Annual-Summaries.md")
}

$template = @'
---
title: {{TITLE}} — Decision & Selection Guide
...
# {{TITLE}} — Decision & Selection Guide

## Executive Core Question
> **"Given my technical and financial requirements, what should I choose for {{TITLE}}?"**

## Selection Framework & Evaluation Criteria
When evaluating options within **{{TITLE}}**, decisions are grounded in 5 core dimensions:
...
foreach ($cat in $categories.Keys) {
    ...
    $readmeFile = Join-Path $dirPath "README.md"
    $listItems = $categories[$cat]
    $linkLines = @()
    foreach ($item in $listItems) {
        $linkLines += "- [" + $item + "](./" + $item + ")"
    }
    $linkStr = $linkLines -join "`n"
    $rTxt = "# " + $cat + " - Decision Index`n`n## Objective`nAnswer the core question: Given my requirements, what should I choose?`n`n## Files`n" + $linkStr
    Set-Content -Path $readmeFile -Value $rTxt -Encoding UTF8
    $count++

    foreach ($f in $categories[$cat]) {
        $fPath = Join-Path $dirPath $f
        $fName = [System.IO.Path]::GetFileNameWithoutExtension($f)

        $cTxt = $template.Replace("{{TITLE}}", $fName).Replace("{{SECTION}}", $cat).Replace("{{FILE}}", $f)
        Set-Content -Path $fPath -Value $cTxt -Encoding UTF8
        $count++
    }
}

# Create Master README.md
$masterReadmePath = Join-Path $baseDir "README.md"
$mTxt = @'
---
...
Set-Content -Path $masterReadmePath -Value $mTxt -Encoding UTF8
$count++

Write-Output "Successfully generated $count structured files across 12 subdirectories in 03-Comparisons!"
