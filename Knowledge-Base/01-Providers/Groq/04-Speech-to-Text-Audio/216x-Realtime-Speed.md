---
title: Groq â€” 216x-Realtime-Speed Specification
provider: Groq
capability: 04-Speech-to-Text-Audio
file: 216x-Realtime-Speed.md
last_updated: 2026-07-28
tags: [groq, lpu, 04-speech-to-text-audio, 216x-realtime-speed]
author: Antigravity AI Documentation Engine
---

# Groq â€” 216x-Realtime-Speed

## Overview
Detailed technical specification for **216x-Realtime-Speed** under **04-Speech-to-Text-Audio**.
