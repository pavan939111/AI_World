---
title: Vertex AI â€” Supervised-Fine-Tuning-SFT Specification
provider: Vertex AI
capability: 05-Custom-Model-Tuning-and-Distillation
file: Supervised-Fine-Tuning-SFT.md
last_updated: 2026-07-28
tags: [vertex-ai, gemini, 05-custom-model-tuning-and-distillation, supervised-fine-tuning-sft]
author: Antigravity AI Documentation Engine
---

# Vertex AI â€” Supervised-Fine-Tuning-SFT

## Overview
Detailed technical specification for **Supervised-Fine-Tuning-SFT** under **05-Custom-Model-Tuning-and-Distillation**.
