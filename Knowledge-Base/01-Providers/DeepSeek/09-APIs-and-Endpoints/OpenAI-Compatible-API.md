---
title: DeepSeek â€” OpenAI-Compatible-API Specification
provider: DeepSeek
capability: 09-APIs-and-Endpoints
file: OpenAI-Compatible-API.md
last_updated: 2026-07-28
tags: [deepseek, deepseek-r1, deepseek-v3, 09-apis-and-endpoints, openai-compatible-api]
...
## Overview
Detailed technical specification for **OpenAI-Compatible-API** under **09-APIs-and-Endpoints**.
