---
title: Google AI â€” Content-Categories Specification
provider: Google AI
capability: 16-Safety-and-Moderation
file: Content-Categories.md
last_updated: 2026-07-28
tags: [google, deepmind, 16-safety-and-moderation, content-categories]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Content-Categories

## Overview
Detailed technical specification for **Content-Categories** under **16-Safety-and-Moderation**.
...
client = genai.Client()
print("Executing Content-Categories query...")
`
