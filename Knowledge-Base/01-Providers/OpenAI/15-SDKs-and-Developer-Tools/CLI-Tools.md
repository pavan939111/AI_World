---
title: OpenAI â€” CLI-Tools Specification
provider: OpenAI
capability: 15-SDKs-and-Developer-Tools
file: CLI-Tools.md
last_updated: 2026-07-28
tags: [openai, 15-sdks-and-developer-tools, cli-tools]
...
## Overview
Detailed technical specification for **CLI-Tools** under **15-SDKs-and-Developer-Tools**.
...
client = OpenAI()
print("Executing CLI-Tools query...")
`
