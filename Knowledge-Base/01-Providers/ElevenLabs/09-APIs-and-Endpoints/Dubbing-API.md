---
title: ElevenLabs â€” Dubbing-API Specification
provider: ElevenLabs
capability: 09-APIs-and-Endpoints
file: Dubbing-API.md
last_updated: 2026-07-28
tags: [elevenlabs, tts, 09-apis-and-endpoints, dubbing-api]
author: Antigravity AI Documentation Engine
---

# ElevenLabs â€” Dubbing-API

## Overview
Detailed technical specification for **Dubbing-API** under **09-APIs-and-Endpoints**.
