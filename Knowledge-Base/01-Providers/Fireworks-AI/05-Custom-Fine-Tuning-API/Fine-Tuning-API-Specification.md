---
title: Fireworks AI â€” Fine-Tuning-API-Specification Specification
provider: Fireworks AI
capability: 05-Custom-Fine-Tuning-API
file: Fine-Tuning-API-Specification.md
last_updated: 2026-07-28
tags: [fireworks-ai, llama, deepseek, 05-custom-fine-tuning-api, fine-tuning-api-specification]
author: Antigravity AI Documentation Engine
---

# Fireworks AI â€” Fine-Tuning-API-Specification

## Overview
Detailed technical specification for **Fine-Tuning-API-Specification** under **05-Custom-Fine-Tuning-API**.
