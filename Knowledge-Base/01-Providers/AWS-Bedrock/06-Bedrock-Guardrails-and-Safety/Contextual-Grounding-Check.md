---
title: AWS Bedrock â€” Contextual-Grounding-Check Specification
provider: AWS Bedrock
capability: 06-Bedrock-Guardrails-and-Safety
file: Contextual-Grounding-Check.md
last_updated: 2026-07-28
tags: [aws-bedrock, amazon-nova, claude, 06-bedrock-guardrails-and-safety, contextual-grounding-check]
author: Antigravity AI Documentation Engine
---

# AWS Bedrock â€” Contextual-Grounding-Check

## Overview
Detailed technical specification for **Contextual-Grounding-Check** under **06-Bedrock-Guardrails-and-Safety**.
