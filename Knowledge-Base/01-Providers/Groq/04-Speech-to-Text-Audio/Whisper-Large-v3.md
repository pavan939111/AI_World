---
title: Groq â€” Whisper-Large-v3 Specification
provider: Groq
capability: 04-Speech-to-Text-Audio
file: Whisper-Large-v3.md
last_updated: 2026-07-28
tags: [groq, lpu, 04-speech-to-text-audio, whisper-large-v3]
author: Antigravity AI Documentation Engine
---

# Groq â€” Whisper-Large-v3

## Overview
Detailed technical specification for **Whisper-Large-v3** under **04-Speech-to-Text-Audio**.
