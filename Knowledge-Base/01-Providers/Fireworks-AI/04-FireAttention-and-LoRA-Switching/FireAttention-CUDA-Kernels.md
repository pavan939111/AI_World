---
title: Fireworks AI â€” FireAttention-CUDA-Kernels Specification
provider: Fireworks AI
capability: 04-FireAttention-and-LoRA-Switching
file: FireAttention-CUDA-Kernels.md
last_updated: 2026-07-28
tags: [fireworks-ai, llama, deepseek, 04-fireattention-and-lora-switching, fireattention-cuda-kernels]
author: Antigravity AI Documentation Engine
---

# Fireworks AI â€” FireAttention-CUDA-Kernels

## Overview
Detailed technical specification for **FireAttention-CUDA-Kernels** under **04-FireAttention-and-LoRA-Switching**.
