---
title: Choosing-an-LLM â€” Decision & Selection Guide
category: 03-Comparisons
section: 08-Architecture-Decisions
file: Choosing-an-LLM.md
last_updated: 2026-07-28
tags: [comparisons, decision-tree, ai-decision-making]
author: Antigravity AI Knowledge Engine
---

# Choosing-an-LLM â€” Decision & Selection Guide

## Executive Core Question
> **"Given my technical and financial requirements, what should I choose for Choosing-an-LLM?"**

## Selection Framework & Evaluation Criteria
When evaluating options within **Choosing-an-LLM**, decisions are grounded in 5 core dimensions:
