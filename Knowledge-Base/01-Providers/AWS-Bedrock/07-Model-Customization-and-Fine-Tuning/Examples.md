---
title: AWS Bedrock â€” Examples Specification
provider: AWS Bedrock
capability: 07-Model-Customization-and-Fine-Tuning
file: Examples.md
last_updated: 2026-07-28
tags: [aws-bedrock, amazon-nova, claude, 07-model-customization-and-fine-tuning, examples]
author: Antigravity AI Documentation Engine
---

# AWS Bedrock â€” Examples

## Overview
Detailed technical specification for **Examples** under **07-Model-Customization-and-Fine-Tuning**.
