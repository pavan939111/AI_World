---
title: Google AI â€” Supported-Models Specification
provider: Google AI
capability: 04-Vision-and-Video-Understanding
file: Supported-Models.md
last_updated: 2026-07-28
tags: [google, deepmind, 04-vision-and-video-understanding, supported-models]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Supported-Models

## Overview
Detailed technical specification for **Supported-Models** under **04-Vision-and-Video-Understanding**.
...
client = genai.Client()
print("Executing Supported-Models query...")
`
