---
title: Fireworks AI â€” JSON-Schema-Mode Specification
provider: Fireworks AI
capability: 06-Structured-Outputs-and-Tool-Calling
file: JSON-Schema-Mode.md
last_updated: 2026-07-28
tags: [fireworks-ai, llama, deepseek, 06-structured-outputs-and-tool-calling, json-schema-mode]
author: Antigravity AI Documentation Engine
---

# Fireworks AI â€” JSON-Schema-Mode

## Overview
Detailed technical specification for **JSON-Schema-Mode** under **06-Structured-Outputs-and-Tool-Calling**.
