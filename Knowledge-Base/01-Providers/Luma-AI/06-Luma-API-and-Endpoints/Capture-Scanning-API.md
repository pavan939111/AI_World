---
title: Luma AI â€” Capture-Scanning-API Specification
provider: Luma AI
capability: 06-Luma-API-and-Endpoints
file: Capture-Scanning-API.md
last_updated: 2026-07-28
tags: [luma-ai, dream-machine, 06-luma-api-and-endpoints, capture-scanning-api]
author: Antigravity AI Documentation Engine
---

# Luma AI â€” Capture-Scanning-API

## Overview
Detailed technical specification for **Capture-Scanning-API** under **06-Luma-API-and-Endpoints**.
