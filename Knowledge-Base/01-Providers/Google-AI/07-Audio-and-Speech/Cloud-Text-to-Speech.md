---
title: Google AI â€” Cloud-Text-to-Speech Specification
provider: Google AI
capability: 07-Audio-and-Speech
file: Cloud-Text-to-Speech.md
last_updated: 2026-07-28
tags: [google, deepmind, 07-audio-and-speech, cloud-text-to-speech]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Cloud-Text-to-Speech

## Overview
Detailed technical specification for **Cloud-Text-to-Speech** under **07-Audio-and-Speech**.
...
client = genai.Client()
print("Executing Cloud-Text-to-Speech query...")
`
