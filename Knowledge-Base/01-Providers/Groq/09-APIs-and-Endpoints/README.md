---
title: Groq â€” 09-APIs-and-Endpoints Overview
provider: Groq
capability: 09-APIs-and-Endpoints
last_updated: 2026-07-28
tags: [groq, lpu, 09-apis-and-endpoints]
author: Antigravity AI Documentation Engine
---

# Groq â€” 09-APIs-and-Endpoints

## 1. What This Capability Is
OpenAI-compatible REST API endpoints catalog.

## 2. When to Use It
Comprehensive production guidance for when to select **09-APIs-and-Endpoints** on Groq LPU hardware for ultra-low latency AI applications.
