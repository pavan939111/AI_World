---
title: Cartesia-Sonic â€” Best-Practices
service: 10-Text-to-Speech
model: Cartesia-Sonic
section: 03-Models
file: Best-Practices.md
last_updated: 2026-07-28
tags: [text-to-speech, cartesia-sonic, best-practices]
author: Antigravity AI Knowledge Engine
---

# Cartesia-Sonic â€” Best-Practices

## Model Specification: Cartesia-Sonic
- **Model Name**: Cartesia-Sonic
...
## Code Example (Cartesia-Sonic API Request)
`python
import os
import requests
