---
title: Cartesia â€” WebSockets-Streaming-API Specification
provider: Cartesia
capability: 03-Realtime-Audio-Streaming-WebSockets
file: WebSockets-Streaming-API.md
last_updated: 2026-07-28
tags: [cartesia, sonic, 03-realtime-audio-streaming-websockets, websockets-streaming-api]
author: Antigravity AI Documentation Engine
---

# Cartesia â€” WebSockets-Streaming-API

## Overview
Detailed technical specification for **WebSockets-Streaming-API** under **03-Realtime-Audio-Streaming-WebSockets**.
