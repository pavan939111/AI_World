---
title: Jina AI â€” Two-Stage-Retrieval-Pipeline Specification
provider: Jina AI
capability: 02-Reranking-Models
file: Two-Stage-Retrieval-Pipeline.md
last_updated: 2026-07-28
tags: [jina-ai, jina-embeddings-v3, 02-reranking-models, two-stage-retrieval-pipeline]
author: Antigravity AI Documentation Engine
---

# Jina AI â€” Two-Stage-Retrieval-Pipeline

## Overview
Detailed technical specification for **Two-Stage-Retrieval-Pipeline** under **02-Reranking-Models**.
