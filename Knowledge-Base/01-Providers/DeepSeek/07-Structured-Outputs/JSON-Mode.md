---
title: DeepSeek â€” JSON-Mode Specification
provider: DeepSeek
capability: 07-Structured-Outputs
file: JSON-Mode.md
last_updated: 2026-07-28
tags: [deepseek, deepseek-r1, deepseek-v3, 07-structured-outputs, json-mode]
author: Antigravity AI Documentation Engine
---

# DeepSeek â€” JSON-Mode

## Overview
Detailed technical specification for **JSON-Mode** under **07-Structured-Outputs**.
