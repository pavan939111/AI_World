---
title: NVIDIA AI â€” Rerank-API Specification
provider: NVIDIA
capability: 07-APIs-and-Endpoints
file: Rerank-API.md
last_updated: 2026-07-28
tags: [nvidia, nim, nemotron, 07-apis-and-endpoints, rerank-api]
author: Antigravity AI Documentation Engine
---

# NVIDIA AI â€” Rerank-API

## Overview
Detailed technical specification for **Rerank-API** under **07-APIs-and-Endpoints**.
