---
title: Meta AI â€” AWS-Bedrock-Llama Specification
provider: Meta
capability: 12-Cloud-Partner-APIs
file: AWS-Bedrock-Llama.md
last_updated: 2026-07-28
tags: [meta, llama, 12-cloud-partner-apis, aws-bedrock-llama]
author: Antigravity AI Documentation Engine
---

# Meta AI â€” AWS-Bedrock-Llama

## Overview
Detailed technical specification for **AWS-Bedrock-Llama** under **12-Cloud-Partner-APIs**.
