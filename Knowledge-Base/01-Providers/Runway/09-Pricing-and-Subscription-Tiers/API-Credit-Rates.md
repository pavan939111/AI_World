---
title: Runway â€” API-Credit-Rates Specification
provider: Runway
capability: 09-Pricing-and-Subscription-Tiers
file: API-Credit-Rates.md
last_updated: 2026-07-28
tags: [runway, gen-3-alpha, 09-pricing-and-subscription-tiers, api-credit-rates]
author: Antigravity AI Documentation Engine
---

# Runway â€” API-Credit-Rates

## Overview
Detailed technical specification for **API-Credit-Rates** under **09-Pricing-and-Subscription-Tiers**.
