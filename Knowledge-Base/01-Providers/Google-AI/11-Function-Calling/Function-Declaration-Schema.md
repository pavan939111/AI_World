---
title: Google AI â€” Function-Declaration-Schema Specification
provider: Google AI
capability: 11-Function-Calling
file: Function-Declaration-Schema.md
last_updated: 2026-07-28
tags: [google, deepmind, 11-function-calling, function-declaration-schema]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Function-Declaration-Schema

## Overview
Detailed technical specification for **Function-Declaration-Schema** under **11-Function-Calling**.
...
client = genai.Client()
print("Executing Function-Declaration-Schema query...")
`
