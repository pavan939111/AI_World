---
title: Cohere â€” Two-Stage-Retrieval-Embed-Rerank Specification
provider: Cohere
capability: 14-Architectures-and-Examples
file: Two-Stage-Retrieval-Embed-Rerank.md
last_updated: 2026-07-28
tags: [cohere, command, rerank, 14-architectures-and-examples, two-stage-retrieval-embed-rerank]
author: Antigravity AI Documentation Engine
---

# Cohere â€” Two-Stage-Retrieval-Embed-Rerank

## Overview
Detailed technical specification for **Two-Stage-Retrieval-Embed-Rerank** under **14-Architectures-and-Examples**.
