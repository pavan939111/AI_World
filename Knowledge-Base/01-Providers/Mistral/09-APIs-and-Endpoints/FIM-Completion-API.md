---
title: Mistral â€” FIM-Completion-API Specification
provider: Mistral
capability: 09-APIs-and-Endpoints
file: FIM-Completion-API.md
last_updated: 2026-07-28
tags: [mistral, moe, 09-apis-and-endpoints, fim-completion-api]
author: Antigravity AI Documentation Engine
---

# Mistral â€” FIM-Completion-API

## Overview
Detailed technical specification for **FIM-Completion-API** under **09-APIs-and-Endpoints**.
