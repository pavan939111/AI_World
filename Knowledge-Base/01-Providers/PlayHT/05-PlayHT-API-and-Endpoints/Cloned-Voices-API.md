---
title: PlayHT â€” Cloned-Voices-API Specification
provider: PlayHT
capability: 05-PlayHT-API-and-Endpoints
file: Cloned-Voices-API.md
last_updated: 2026-07-28
tags: [playht, tts, 05-playht-api-and-endpoints, cloned-voices-api]
author: Antigravity AI Documentation Engine
---

# PlayHT â€” Cloned-Voices-API

## Overview
Detailed technical specification for **Cloned-Voices-API** under **05-PlayHT-API-and-Endpoints**.
