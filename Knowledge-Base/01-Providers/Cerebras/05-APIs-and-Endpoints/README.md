---
title: Cerebras â€” 05-APIs-and-Endpoints Overview
provider: Cerebras
capability: 05-APIs-and-Endpoints
last_updated: 2026-07-28
tags: [cerebras, wse-3, llama-3-3-70b, 2100-tokens-per-second, wafer-scale, 05-apis-and-endpoints]
author: Antigravity AI Documentation Engine
---

# Cerebras â€” 05-APIs-and-Endpoints

## 1. What This Capability Is
OpenAI-compatible REST API catalog (pi.cerebras.ai/v1).

## 2. When to Use It
Comprehensive production guidance for when to select **05-APIs-and-Endpoints** in Cerebras ultra-fast wafer-scale inference applications.
