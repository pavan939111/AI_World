---
title: Meta AI â€” Llama-Stack-Architecture Specification
provider: Meta
capability: 06-Llama-Stack-API-Standard
file: Llama-Stack-Architecture.md
last_updated: 2026-07-28
tags: [meta, llama, 06-llama-stack-api-standard, llama-stack-architecture]
author: Antigravity AI Documentation Engine
---

# Meta AI â€” Llama-Stack-Architecture

## Overview
Detailed technical specification for **Llama-Stack-Architecture** under **06-Llama-Stack-API-Standard**.
