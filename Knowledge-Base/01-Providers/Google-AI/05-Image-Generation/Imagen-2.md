---
title: Google AI â€” Imagen-2 Specification
provider: Google AI
capability: 05-Image-Generation
file: Imagen-2.md
last_updated: 2026-07-28
tags: [google, deepmind, 05-image-generation, imagen-2]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Imagen-2

## Overview
Detailed technical specification for **Imagen-2** under **05-Image-Generation**.
...
client = genai.Client()
print("Executing Imagen-2 query...")
`
