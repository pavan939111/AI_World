---
title: Luma AI â€” 06-Luma-API-and-Endpoints Overview
provider: Luma AI
capability: 06-Luma-API-and-Endpoints
last_updated: 2026-07-28
tags: [luma-ai, dream-machine, genie, photon, 3d, video-generation, 06-luma-api-and-endpoints]
author: Antigravity AI Documentation Engine
---

# Luma AI â€” 06-Luma-API-and-Endpoints

## 1. What This Capability Is
Official Luma REST API (pi.lumalabs.ai/v1).

## 2. When to Use It
Comprehensive production guidance for when to select **06-Luma-API-and-Endpoints** in Luma AI 3D, video, and image applications.
