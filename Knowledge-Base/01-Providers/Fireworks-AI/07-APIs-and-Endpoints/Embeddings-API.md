---
title: Fireworks AI â€” Embeddings-API Specification
provider: Fireworks AI
capability: 07-APIs-and-Endpoints
file: Embeddings-API.md
last_updated: 2026-07-28
tags: [fireworks-ai, llama, deepseek, 07-apis-and-endpoints, embeddings-api]
author: Antigravity AI Documentation Engine
---

# Fireworks AI â€” Embeddings-API

## Overview
Detailed technical specification for **Embeddings-API** under **07-APIs-and-Endpoints**.
