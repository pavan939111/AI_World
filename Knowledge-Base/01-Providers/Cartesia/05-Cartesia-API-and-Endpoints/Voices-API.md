---
title: Cartesia â€” Voices-API Specification
provider: Cartesia
capability: 05-Cartesia-API-and-Endpoints
file: Voices-API.md
last_updated: 2026-07-28
tags: [cartesia, sonic, 05-cartesia-api-and-endpoints, voices-api]
author: Antigravity AI Documentation Engine
---

# Cartesia â€” Voices-API

## Overview
Detailed technical specification for **Voices-API** under **05-Cartesia-API-and-Endpoints**.
