---
title: Voyage AI â€” Multimodal-Embeddings-API Specification
provider: Voyage AI
capability: 06-Voyage-API-and-Endpoints
file: Multimodal-Embeddings-API.md
last_updated: 2026-07-28
tags: [voyage-ai, voyage-3, 06-voyage-api-and-endpoints, multimodal-embeddings-api]
author: Antigravity AI Documentation Engine
---

# Voyage AI â€” Multimodal-Embeddings-API

## Overview
Detailed technical specification for **Multimodal-Embeddings-API** under **06-Voyage-API-and-Endpoints**.
