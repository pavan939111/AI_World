---
title: Runway â€” Tasks-Polling-API Specification
provider: Runway
capability: 07-Runway-API-and-Endpoints
file: Tasks-Polling-API.md
last_updated: 2026-07-28
tags: [runway, gen-3-alpha, 07-runway-api-and-endpoints, tasks-polling-api]
author: Antigravity AI Documentation Engine
---

# Runway â€” Tasks-Polling-API

## Overview
Detailed technical specification for **Tasks-Polling-API** under **07-Runway-API-and-Endpoints**.
