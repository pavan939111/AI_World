---
title: Cohere â€” rerank-multilingual-v3-0 Specification
provider: Cohere
capability: 02-Reranking-Models
file: rerank-multilingual-v3-0.md
last_updated: 2026-07-28
tags: [cohere, command, rerank, 02-reranking-models, rerank-multilingual-v3-0]
author: Antigravity AI Documentation Engine
---

# Cohere â€” rerank-multilingual-v3-0

## Overview
Detailed technical specification for **rerank-multilingual-v3-0** under **02-Reranking-Models**.
