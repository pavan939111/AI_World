---
title: DeepSeek â€” DeepSeek-V2-5 Specification
provider: DeepSeek
capability: 02-Language-Models
file: DeepSeek-V2-5.md
last_updated: 2026-07-28
tags: [deepseek, deepseek-r1, deepseek-v3, 02-language-models, deepseek-v2-5]
author: Antigravity AI Documentation Engine
---

# DeepSeek â€” DeepSeek-V2-5

## Overview
Detailed technical specification for **DeepSeek-V2-5** under **02-Language-Models**.
