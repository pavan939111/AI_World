---
title: Runway â€” Image-to-Video-API Specification
provider: Runway
capability: 07-Runway-API-and-Endpoints
file: Image-to-Video-API.md
last_updated: 2026-07-28
tags: [runway, gen-3-alpha, 07-runway-api-and-endpoints, image-to-video-api]
author: Antigravity AI Documentation Engine
---

# Runway â€” Image-to-Video-API

## Overview
Detailed technical specification for **Image-to-Video-API** under **07-Runway-API-and-Endpoints**.
