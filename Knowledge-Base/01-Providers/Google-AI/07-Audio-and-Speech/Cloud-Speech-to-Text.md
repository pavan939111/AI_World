---
title: Google AI â€” Cloud-Speech-to-Text Specification
provider: Google AI
capability: 07-Audio-and-Speech
file: Cloud-Speech-to-Text.md
last_updated: 2026-07-28
tags: [google, deepmind, 07-audio-and-speech, cloud-speech-to-text]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Cloud-Speech-to-Text

## Overview
Detailed technical specification for **Cloud-Speech-to-Text** under **07-Audio-and-Speech**.
...
client = genai.Client()
print("Executing Cloud-Speech-to-Text query...")
`
