---
title: Cohere â€” Int8-and-Binary-Quantized-Embeddings Specification
provider: Cohere
capability: 03-Embedding-Models
file: Int8-and-Binary-Quantized-Embeddings.md
last_updated: 2026-07-28
tags: [cohere, command, rerank, 03-embedding-models, int8-and-binary-quantized-embeddings]
author: Antigravity AI Documentation Engine
---

# Cohere â€” Int8-and-Binary-Quantized-Embeddings

## Overview
Detailed technical specification for **Int8-and-Binary-Quantized-Embeddings** under **03-Embedding-Models**.
