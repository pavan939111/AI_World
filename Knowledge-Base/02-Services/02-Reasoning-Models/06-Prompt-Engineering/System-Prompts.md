---
title: Reasoning Models â€” System-Prompts
service: 02-Reasoning-Models
section: 06-Prompt-Engineering
file: System-Prompts.md
last_updated: 2026-07-28
tags: [reasoning-models, deepseek-r1, o1, cot, 06-prompt-engineering, system-prompts]
...
## Executive Summary
Detailed technical breakdown of **System-Prompts** within the **06-Prompt-Engineering** domain of AI Reasoning Models (Chain-of-Thought / Test-Time Compute Scaling).
...
## Detailed Analysis
1. **Technical Foundation**: How System-Prompts optimizes test-time compute, error backtracking, self-correction, and logical verification.
