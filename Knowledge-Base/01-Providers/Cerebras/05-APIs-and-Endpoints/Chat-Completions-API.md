---
title: Cerebras â€” Chat-Completions-API Specification
provider: Cerebras
capability: 05-APIs-and-Endpoints
file: Chat-Completions-API.md
last_updated: 2026-07-28
tags: [cerebras, wse-3, 05-apis-and-endpoints, chat-completions-api]
author: Antigravity AI Documentation Engine
---

# Cerebras â€” Chat-Completions-API

## Overview
Detailed technical specification for **Chat-Completions-API** under **05-APIs-and-Endpoints**.
