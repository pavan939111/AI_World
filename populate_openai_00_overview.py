...
overview_dir = r"c:\Users\Admin\Desktop\AI_World\Knowledge-Base\01-Providers\OpenAI\00-Overview"
...
with open(os.path.join(overview_dir, "Company.md"), "w", encoding="utf-8") as f:
    f.write(company_md)

with open(os.path.join(overview_dir, "Ecosystem-Architecture.md"), "w", encoding="utf-8") as f:
    f.write(ecosystem_md)

with open(os.path.join(overview_dir, "History-and-Milestones.md"), "w", encoding="utf-8") as f:
    f.write(history_md)

with open(os.path.join(overview_dir, "Glossary.md"), "w", encoding="utf-8") as f:
    f.write(glossary_md)

with open(os.path.join(overview_dir, "README.md"), "w", encoding="utf-8") as f:
    f.write(readme_md)

print("Successfully research, populated, and verified all 5 files in OpenAI/00-Overview!")
