---
title: Google AI â€” WebSockets-Audio-Streaming Specification
provider: Google AI
capability: 08-Realtime-Voice
file: WebSockets-Audio-Streaming.md
last_updated: 2026-07-28
tags: [google, deepmind, 08-realtime-voice, websockets-audio-streaming]
author: Antigravity AI Documentation Engine
---

# Google AI â€” WebSockets-Audio-Streaming

## Overview
Detailed technical specification for **WebSockets-Audio-Streaming** under **08-Realtime-Voice**.
...
client = genai.Client()
print("Executing WebSockets-Audio-Streaming query...")
`
