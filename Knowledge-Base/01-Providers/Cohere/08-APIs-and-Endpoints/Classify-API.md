---
title: Cohere â€” Classify-API Specification
provider: Cohere
capability: 08-APIs-and-Endpoints
file: Classify-API.md
last_updated: 2026-07-28
tags: [cohere, command, rerank, 08-apis-and-endpoints, classify-api]
author: Antigravity AI Documentation Engine
---

# Cohere â€” Classify-API

## Overview
Detailed technical specification for **Classify-API** under **08-APIs-and-Endpoints**.
