---
title: PlayHT â€” Voices-List-API Specification
provider: PlayHT
capability: 05-PlayHT-API-and-Endpoints
file: Voices-List-API.md
last_updated: 2026-07-28
tags: [playht, tts, 05-playht-api-and-endpoints, voices-list-api]
author: Antigravity AI Documentation Engine
---

# PlayHT â€” Voices-List-API

## Overview
Detailed technical specification for **Voices-List-API** under **05-PlayHT-API-and-Endpoints**.
