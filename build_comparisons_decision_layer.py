...
comparisons_dir = r"c:\Users\Admin\Desktop\AI_World\Knowledge-Base\03-Comparisons"
...
for folder, files in structure.items():
    folder_path = os.path.join(comparisons_dir, folder)
...
tags: [comparisons, decision-making, {folder.lower()}, ai-knowledge-base]
...
"""
    ...
    for file in files:
        ...
        content = f"""---
title: {file_name_no_ext} — Decision & Selection Guide
category: 03-Comparisons
section: {folder}
file: {file}
last_updated: 2026-07-28
tags: [comparisons, decision-tree, {folder.lower()}, {file_name_no_ext.lower()}]
author: Antigravity AI Knowledge Engine
---

# {file_name_no_ext} — Decision & Selection Guide

## Executive Core Question
> **"Given my technical and financial requirements, what should I choose for {file_name_no_ext}?"**

## Selection Framework & Evaluation Criteria
When evaluating options within **{file_name_no_ext}**, decisions must be grounded in 5 core dimensions:
...
with open(os.path.join(comparisons_dir, "README.md"), "w", encoding="utf-8") as f:
    f.write(master_readme)
total_files += 1

print(f"Successfully created {total_files} structured markdown files across 12 subfolders in 03-Comparisons Decision Layer!")
