---
title: Google AI â€” TPU-Context-Caching Specification
provider: Google AI
capability: 14-Context-Caching
file: TPU-Context-Caching.md
last_updated: 2026-07-28
tags: [google, deepmind, 14-context-caching, tpu-context-caching]
author: Antigravity AI Documentation Engine
---

# Google AI â€” TPU-Context-Caching

## Overview
Detailed technical specification for **TPU-Context-Caching** under **14-Context-Caching**.
...
client = genai.Client()
print("Executing TPU-Context-Caching query...")
`
