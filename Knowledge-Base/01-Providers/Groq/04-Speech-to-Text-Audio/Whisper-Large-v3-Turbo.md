---
title: Groq â€” Whisper-Large-v3-Turbo Specification
provider: Groq
capability: 04-Speech-to-Text-Audio
file: Whisper-Large-v3-Turbo.md
last_updated: 2026-07-28
tags: [groq, lpu, 04-speech-to-text-audio, whisper-large-v3-turbo]
author: Antigravity AI Documentation Engine
---

# Groq â€” Whisper-Large-v3-Turbo

## Overview
Detailed technical specification for **Whisper-Large-v3-Turbo** under **04-Speech-to-Text-Audio**.
