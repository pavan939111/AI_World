---
title: Cohere â€” Chat-API Specification
provider: Cohere
capability: 08-APIs-and-Endpoints
file: Chat-API.md
last_updated: 2026-07-28
tags: [cohere, command, rerank, 08-apis-and-endpoints, chat-api]
...
## Overview
Detailed technical specification for **Chat-API** under **08-APIs-and-Endpoints**.
