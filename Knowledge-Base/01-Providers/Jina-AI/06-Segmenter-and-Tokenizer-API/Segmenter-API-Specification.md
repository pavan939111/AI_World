---
title: Jina AI â€” Segmenter-API-Specification Specification
provider: Jina AI
capability: 06-Segmenter-and-Tokenizer-API
file: Segmenter-API-Specification.md
last_updated: 2026-07-28
tags: [jina-ai, jina-embeddings-v3, 06-segmenter-and-tokenizer-api, segmenter-api-specification]
author: Antigravity AI Documentation Engine
---

# Jina AI â€” Segmenter-API-Specification

## Overview
Detailed technical specification for **Segmenter-API-Specification** under **06-Segmenter-and-Tokenizer-API**.
