---
title: Anthropic â€” Ephemeral-Prompt-Caching-90Percent-Discount Specification
provider: Anthropic
capability: 06-Prompt-Caching
file: Ephemeral-Prompt-Caching-90Percent-Discount.md
last_updated: 2026-07-28
tags: [anthropic, claude, 06-prompt-caching, ephemeral-prompt-caching-90percent-discount]
author: Antigravity AI Documentation Engine
---

# Anthropic â€” Ephemeral-Prompt-Caching-90Percent-Discount

## Overview
Detailed technical specification for **Ephemeral-Prompt-Caching-90Percent-Discount** under **06-Prompt-Caching**.
...
print("Executing Ephemeral-Prompt-Caching-90Percent-Discount query...")
`
