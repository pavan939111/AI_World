---
title: Mistral â€” OCR-API Specification
provider: Mistral
capability: 09-APIs-and-Endpoints
file: OCR-API.md
last_updated: 2026-07-28
tags: [mistral, moe, 09-apis-and-endpoints, ocr-api]
...
## Overview
Detailed technical specification for **OCR-API** under **09-APIs-and-Endpoints**.
