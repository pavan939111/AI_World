---
title: Meta AI â€” 08-Tool-Use-Function-Calling Overview
provider: Meta
capability: 08-Tool-Use-Function-Calling
last_updated: 2026-07-28
tags: [meta, llama, open-source, 08-tool-use-function-calling]
author: Antigravity AI Documentation Engine
---

# Meta AI â€” 08-Tool-Use-Function-Calling

## 1. What This Capability Is
Native Llama 3 tool calling formatting.

## 2. When to Use It
Comprehensive production guidance for when to select **08-Tool-Use-Function-Calling** in Meta Llama open-source applications.
