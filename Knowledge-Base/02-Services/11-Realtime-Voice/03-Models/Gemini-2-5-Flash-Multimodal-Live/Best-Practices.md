---
title: Gemini-2-5-Flash-Multimodal-Live â€” Best-Practices
service: 11-Realtime-Voice
model: Gemini-2-5-Flash-Multimodal-Live
section: 03-Models
file: Best-Practices.md
last_updated: 2026-07-28
tags: [realtime-voice, gemini-2-5-flash-multimodal-live, best-practices]
author: Antigravity AI Knowledge Engine
---

# Gemini-2-5-Flash-Multimodal-Live â€” Best-Practices

## Model Specification: Gemini-2-5-Flash-Multimodal-Live
- **Model Name**: Gemini-2-5-Flash-Multimodal-Live
...
## Code Example (Gemini-2-5-Flash-Multimodal-Live API Request)
`javascript
...
ws.onopen = () => {
  ws.send(JSON.stringify({
    type: "session.update",
    session: { model: "gemini-2-5-flash-multimodal-live", voice: "natural_voice_1" }
  }));
};
`
