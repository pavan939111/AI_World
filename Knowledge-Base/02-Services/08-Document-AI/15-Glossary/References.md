---
title: Document AI â€” References
service: 08-Document-AI
section: 15-Glossary
file: References.md
last_updated: 2026-07-28
tags: [document-ai, ocr, idp, 15-glossary, references]
...
## Executive Summary
Detailed technical breakdown of **References** within the **15-Glossary** domain of Document AI, Intelligent Document Processing (IDP), and PDF parsing engines.
...
## Detailed Analysis
1. **Technical Foundation**: How References handles multi-column reading orders, nested table structures, handwritten text OCR, and bounding box geometry.
2. **Production Application**: Best practices for integrating References into accounts payable automation, mortgage application processing, and legal discovery.
