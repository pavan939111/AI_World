---
title: Hugging Face â€” Serverless-Inference-API Specification
provider: Hugging Face
capability: 02-Inference-Endpoints-and-Serverless-API
file: Serverless-Inference-API.md
last_updated: 2026-07-28
tags: [hugging-face, transformers, 02-inference-endpoints-and-serverless-api, serverless-inference-api]
author: Antigravity AI Documentation Engine
---

# Hugging Face â€” Serverless-Inference-API

## Overview
Detailed technical specification for **Serverless-Inference-API** under **02-Inference-Endpoints-and-Serverless-API**.
