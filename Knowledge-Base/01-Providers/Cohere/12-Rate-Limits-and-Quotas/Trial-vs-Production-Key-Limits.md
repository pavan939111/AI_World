---
title: Cohere â€” Trial-vs-Production-Key-Limits Specification
provider: Cohere
capability: 12-Rate-Limits-and-Quotas
file: Trial-vs-Production-Key-Limits.md
last_updated: 2026-07-28
tags: [cohere, command, rerank, 12-rate-limits-and-quotas, trial-vs-production-key-limits]
author: Antigravity AI Documentation Engine
---

# Cohere â€” Trial-vs-Production-Key-Limits

## Overview
Detailed technical specification for **Trial-vs-Production-Key-Limits** under **12-Rate-Limits-and-Quotas**.
