---
title: Replicate â€” DeepSeek-R1-Replicate Specification
provider: Replicate
capability: 03-Open-Language-and-Reasoning-Models
file: DeepSeek-R1-Replicate.md
last_updated: 2026-07-28
tags: [replicate, cog, 03-open-language-and-reasoning-models, deepseek-r1-replicate]
author: Antigravity AI Documentation Engine
---

# Replicate â€” DeepSeek-R1-Replicate

## Overview
Detailed technical specification for **DeepSeek-R1-Replicate** under **03-Open-Language-and-Reasoning-Models**.
