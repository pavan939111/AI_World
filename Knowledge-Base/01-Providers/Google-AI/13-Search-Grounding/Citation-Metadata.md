---
title: Google AI â€” Citation-Metadata Specification
provider: Google AI
capability: 13-Search-Grounding
file: Citation-Metadata.md
last_updated: 2026-07-28
tags: [google, deepmind, 13-search-grounding, citation-metadata]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Citation-Metadata

## Overview
Detailed technical specification for **Citation-Metadata** under **13-Search-Grounding**.
...
client = genai.Client()
print("Executing Citation-Metadata query...")
`
