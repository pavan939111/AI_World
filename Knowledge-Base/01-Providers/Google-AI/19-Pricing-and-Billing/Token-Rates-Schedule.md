---
title: Google AI â€” Token-Rates-Schedule Specification
provider: Google AI
capability: 19-Pricing-and-Billing
file: Token-Rates-Schedule.md
last_updated: 2026-07-28
tags: [google, deepmind, 19-pricing-and-billing, token-rates-schedule]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Token-Rates-Schedule

## Overview
Detailed technical specification for **Token-Rates-Schedule** under **19-Pricing-and-Billing**.
