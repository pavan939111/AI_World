---
title: Google AI â€” SynthID-Watermarking Specification
provider: Google AI
capability: 05-Image-Generation
file: SynthID-Watermarking.md
last_updated: 2026-07-28
tags: [google, deepmind, 05-image-generation, synthid-watermarking]
author: Antigravity AI Documentation Engine
---

# Google AI â€” SynthID-Watermarking

## Overview
Detailed technical specification for **SynthID-Watermarking** under **05-Image-Generation**.
...
client = genai.Client()
print("Executing SynthID-Watermarking query...")
`
