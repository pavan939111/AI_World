---
title: xAI â€” OpenAI-Compatible-API Specification
provider: xAI
capability: 07-APIs-and-Endpoints
file: OpenAI-Compatible-API.md
last_updated: 2026-07-28
tags: [xai, grok, 07-apis-and-endpoints, openai-compatible-api]
author: Antigravity AI Documentation Engine
---

# xAI â€” OpenAI-Compatible-API

## Overview
Detailed technical specification for **OpenAI-Compatible-API** under **07-APIs-and-Endpoints**.
