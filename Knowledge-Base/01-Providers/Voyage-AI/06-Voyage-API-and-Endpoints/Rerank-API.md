---
title: Voyage AI â€” Rerank-API Specification
provider: Voyage AI
capability: 06-Voyage-API-and-Endpoints
file: Rerank-API.md
last_updated: 2026-07-28
tags: [voyage-ai, voyage-3, 06-voyage-api-and-endpoints, rerank-api]
author: Antigravity AI Documentation Engine
---

# Voyage AI â€” Rerank-API

## Overview
Detailed technical specification for **Rerank-API** under **06-Voyage-API-and-Endpoints**.
