---
title: ElevenLabs â€” Voices-Management-API Specification
provider: ElevenLabs
capability: 09-APIs-and-Endpoints
file: Voices-Management-API.md
last_updated: 2026-07-28
tags: [elevenlabs, tts, 09-apis-and-endpoints, voices-management-api]
author: Antigravity AI Documentation Engine
---

# ElevenLabs â€” Voices-Management-API

## Overview
Detailed technical specification for **Voices-Management-API** under **09-APIs-and-Endpoints**.
