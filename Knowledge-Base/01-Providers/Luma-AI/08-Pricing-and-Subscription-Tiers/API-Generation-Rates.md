---
title: Luma AI â€” API-Generation-Rates Specification
provider: Luma AI
capability: 08-Pricing-and-Subscription-Tiers
file: API-Generation-Rates.md
last_updated: 2026-07-28
tags: [luma-ai, dream-machine, 08-pricing-and-subscription-tiers, api-generation-rates]
author: Antigravity AI Documentation Engine
---

# Luma AI â€” API-Generation-Rates

## Overview
Detailed technical specification for **API-Generation-Rates** under **08-Pricing-and-Subscription-Tiers**.
