---
title: bge-reranker-large â€” Best-Practices
service: 04-Reranking-Models
model: bge-reranker-large
section: 03-Models
file: Best-Practices.md
last_updated: 2026-07-28
tags: [reranking-models, bge-reranker-large, best-practices]
author: Antigravity AI Knowledge Engine
---

# bge-reranker-large â€” Best-Practices

## Model Specification: bge-reranker-large
...
## Code Example (bge-reranker-large Request)
`python
import os
import requests
