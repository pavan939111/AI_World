---
title: ElevenLabs â€” Eleven-Turbo-v2-5 Specification
provider: ElevenLabs
capability: 01-Text-to-Speech-TTS
file: Eleven-Turbo-v2-5.md
last_updated: 2026-07-28
tags: [elevenlabs, tts, 01-text-to-speech-tts, eleven-turbo-v2-5]
author: Antigravity AI Documentation Engine
---

# ElevenLabs â€” Eleven-Turbo-v2-5

## Overview
Detailed technical specification for **Eleven-Turbo-v2-5** under **01-Text-to-Speech-TTS**.
