---
title: Black Forest Labs â€” Rectified-Flow-Transformer-Architecture Specification
provider: Black Forest Labs
capability: 00-Overview
file: Rectified-Flow-Transformer-Architecture.md
last_updated: 2026-07-28
tags: [black-forest-labs, flux, 00-overview, rectified-flow-transformer-architecture]
author: Antigravity AI Documentation Engine
---

# Black Forest Labs â€” Rectified-Flow-Transformer-Architecture

## Overview
Detailed technical specification for **Rectified-Flow-Transformer-Architecture** under **00-Overview**.
