---
title: Together AI â€” FlashAttention-3-and-Speculative-Decoding Specification
provider: Together AI
capability: 04-Together-Kernel-Inference-Engine
file: FlashAttention-3-and-Speculative-Decoding.md
last_updated: 2026-07-28
tags: [together-ai, llama, deepseek, 04-together-kernel-inference-engine, flashattention-3-and-speculative-decoding]
author: Antigravity AI Documentation Engine
---

# Together AI â€” FlashAttention-3-and-Speculative-Decoding

## Overview
Detailed technical specification for **FlashAttention-3-and-Speculative-Decoding** under **04-Together-Kernel-Inference-Engine**.
