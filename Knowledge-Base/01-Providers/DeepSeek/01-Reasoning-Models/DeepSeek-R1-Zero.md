---
title: DeepSeek â€” DeepSeek-R1-Zero Specification
provider: DeepSeek
capability: 01-Reasoning-Models
file: DeepSeek-R1-Zero.md
last_updated: 2026-07-28
tags: [deepseek, deepseek-r1, deepseek-v3, 01-reasoning-models, deepseek-r1-zero]
author: Antigravity AI Documentation Engine
---

# DeepSeek â€” DeepSeek-R1-Zero

## Overview
Detailed technical specification for **DeepSeek-R1-Zero** under **01-Reasoning-Models**.
