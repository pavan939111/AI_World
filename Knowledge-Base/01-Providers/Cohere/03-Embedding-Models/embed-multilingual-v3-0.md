---
title: Cohere â€” embed-multilingual-v3-0 Specification
provider: Cohere
capability: 03-Embedding-Models
file: embed-multilingual-v3-0.md
last_updated: 2026-07-28
tags: [cohere, command, rerank, 03-embedding-models, embed-multilingual-v3-0]
author: Antigravity AI Documentation Engine
---

# Cohere â€” embed-multilingual-v3-0

## Overview
Detailed technical specification for **embed-multilingual-v3-0** under **03-Embedding-Models**.
