---
title: Reranking Models â€” History
service: 04-Reranking-Models
section: 00-Overview
file: History.md
last_updated: 2026-07-28
tags: [reranking-models, cross-encoder, ndcg, 00-overview, history]
...
## Executive Summary
Detailed technical breakdown of **History** within the **00-Overview** domain of Cross-Encoder Reranking Models & Two-Stage Information Retrieval.
...
## Detailed Analysis
1. **Technical Foundation**: How History computes full cross-attention between query and document text to dramatically outperform bi-encoder vector similarity on precision benchmarks.
2. **Production Application**: Best practices for implementing History in RAG pipelines to eliminate irrelevant context noise and reduce LLM prompt token costs.
