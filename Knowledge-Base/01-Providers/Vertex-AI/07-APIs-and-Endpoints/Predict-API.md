---
title: Vertex AI â€” Predict-API Specification
provider: Vertex AI
capability: 07-APIs-and-Endpoints
file: Predict-API.md
last_updated: 2026-07-28
tags: [vertex-ai, gemini, 07-apis-and-endpoints, predict-api]
author: Antigravity AI Documentation Engine
---

# Vertex AI â€” Predict-API

## Overview
Detailed technical specification for **Predict-API** under **07-APIs-and-Endpoints**.
