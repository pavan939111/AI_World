---
title: Anthropic â€” Computer-Use-API Specification
provider: Anthropic
capability: 04-Computer-Use
file: Computer-Use-API.md
last_updated: 2026-07-28
tags: [anthropic, claude, 04-computer-use, computer-use-api]
author: Antigravity AI Documentation Engine
---

# Anthropic â€” Computer-Use-API

## Overview
Detailed technical specification for **Computer-Use-API** under **04-Computer-Use**.
...
print("Executing Computer-Use-API query...")
`
