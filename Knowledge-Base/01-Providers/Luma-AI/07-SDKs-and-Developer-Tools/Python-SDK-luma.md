---
title: Luma AI â€” Python-SDK-luma Specification
provider: Luma AI
capability: 07-SDKs-and-Developer-Tools
file: Python-SDK-luma.md
last_updated: 2026-07-28
tags: [luma-ai, dream-machine, 07-sdks-and-developer-tools, python-sdk-luma]
author: Antigravity AI Documentation Engine
---

# Luma AI â€” Python-SDK-luma

## Overview
Detailed technical specification for **Python-SDK-luma** under **07-SDKs-and-Developer-Tools**.
