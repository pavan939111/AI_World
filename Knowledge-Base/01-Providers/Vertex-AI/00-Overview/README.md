---
title: Vertex AI â€” 00-Overview Overview
provider: Vertex AI
capability: 00-Overview
last_updated: 2026-07-28
tags: [vertex-ai, google-cloud, gemini-2-5, model-garden, agent-builder, mlops, 00-overview]
author: Antigravity AI Documentation Engine
---

# Vertex AI â€” 00-Overview

## 1. What This Capability Is
Overview of Vertex AI & Google Cloud Enterprise AI Platform.

## 2. When to Use It
Comprehensive production guidance for when to select **00-Overview** in Google Cloud enterprise AI applications.
