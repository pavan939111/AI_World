---
title: DeepSeek â€” Tool-Calling-Specification Specification
provider: DeepSeek
capability: 06-Tool-Use-Function-Calling
file: Tool-Calling-Specification.md
last_updated: 2026-07-28
tags: [deepseek, deepseek-r1, deepseek-v3, 06-tool-use-function-calling, tool-calling-specification]
author: Antigravity AI Documentation Engine
---

# DeepSeek â€” Tool-Calling-Specification

## Overview
Detailed technical specification for **Tool-Calling-Specification** under **06-Tool-Use-Function-Calling**.
