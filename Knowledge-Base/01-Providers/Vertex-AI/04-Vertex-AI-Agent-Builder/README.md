---
title: Vertex AI â€” 04-Vertex-AI-Agent-Builder Overview
provider: Vertex AI
capability: 04-Vertex-AI-Agent-Builder
last_updated: 2026-07-28
tags: [vertex-ai, google-cloud, gemini-2-5, model-garden, agent-builder, mlops, 04-vertex-ai-agent-builder]
author: Antigravity AI Documentation Engine
---

# Vertex AI â€” 04-Vertex-AI-Agent-Builder

## 1. What This Capability Is
No-code and low-code agent creation environment.

## 2. When to Use It
Comprehensive production guidance for when to select **04-Vertex-AI-Agent-Builder** in Google Cloud enterprise AI applications.
