---
title: Replicate â€” Predictions-API Specification
provider: Replicate
capability: 06-Replicate-API-and-Endpoints
file: Predictions-API.md
last_updated: 2026-07-28
tags: [replicate, cog, 06-replicate-api-and-endpoints, predictions-api]
author: Antigravity AI Documentation Engine
---

# Replicate â€” Predictions-API

## Overview
Detailed technical specification for **Predictions-API** under **06-Replicate-API-and-Endpoints**.
