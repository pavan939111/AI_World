---
title: Anthropic â€” RPM-TPM-Tables Specification
provider: Anthropic
capability: 15-Rate-Limits-and-Quotas
file: RPM-TPM-Tables.md
last_updated: 2026-07-28
tags: [anthropic, claude, 15-rate-limits-and-quotas, rpm-tpm-tables]
author: Antigravity AI Documentation Engine
---

# Anthropic â€” RPM-TPM-Tables

## Overview
Detailed technical specification for **RPM-TPM-Tables** under **15-Rate-Limits-and-Quotas**.
...
print("Executing RPM-TPM-Tables query...")
`
