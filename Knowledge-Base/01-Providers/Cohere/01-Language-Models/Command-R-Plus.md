---
title: Cohere â€” Command-R-Plus Specification
provider: Cohere
capability: 01-Language-Models
file: Command-R-Plus.md
last_updated: 2026-07-28
tags: [cohere, command, rerank, 01-language-models, command-r-plus]
author: Antigravity AI Documentation Engine
---

# Cohere â€” Command-R-Plus

## Overview
Detailed technical specification for **Command-R-Plus** under **01-Language-Models**.
