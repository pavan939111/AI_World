---
title: Kling AI â€” Task-Polling-API Specification
provider: Kling AI
capability: 06-Kling-API-and-Endpoints
file: Task-Polling-API.md
last_updated: 2026-07-28
tags: [kling-ai, kling-1-5, 06-kling-api-and-endpoints, task-polling-api]
author: Antigravity AI Documentation Engine
---

# Kling AI â€” Task-Polling-API

## Overview
Detailed technical specification for **Task-Polling-API** under **06-Kling-API-and-Endpoints**.
