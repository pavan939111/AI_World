---
title: NVIDIA AI â€” OpenAI-API-Compatibility Specification
provider: NVIDIA
capability: 05-NVIDIA-build-Cloud-APIs
file: OpenAI-API-Compatibility.md
last_updated: 2026-07-28
tags: [nvidia, nim, nemotron, 05-nvidia-build-cloud-apis, openai-api-compatibility]
author: Antigravity AI Documentation Engine
---

# NVIDIA AI â€” OpenAI-API-Compatibility

## Overview
Detailed technical specification for **OpenAI-API-Compatibility** under **05-NVIDIA-build-Cloud-APIs**.
