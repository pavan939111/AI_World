---
title: NVIDIA AI â€” CUDA-and-Tensor-Core-Architecture Specification
provider: NVIDIA
capability: 00-Overview
file: CUDA-and-Tensor-Core-Architecture.md
last_updated: 2026-07-28
tags: [nvidia, nim, nemotron, 00-overview, cuda-and-tensor-core-architecture]
author: Antigravity AI Documentation Engine
---

# NVIDIA AI â€” CUDA-and-Tensor-Core-Architecture

## Overview
Detailed technical specification for **CUDA-and-Tensor-Core-Architecture** under **00-Overview**.
