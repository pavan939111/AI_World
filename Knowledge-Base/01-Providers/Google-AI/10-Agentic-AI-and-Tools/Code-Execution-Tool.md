---
title: Google AI â€” Code-Execution-Tool Specification
provider: Google AI
capability: 10-Agentic-AI-and-Tools
file: Code-Execution-Tool.md
last_updated: 2026-07-28
tags: [google, deepmind, 10-agentic-ai-and-tools, code-execution-tool]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Code-Execution-Tool

## Overview
Detailed technical specification for **Code-Execution-Tool** under **10-Agentic-AI-and-Tools**.
...
client = genai.Client()
print("Executing Code-Execution-Tool query...")
`
