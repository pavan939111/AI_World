---
title: Cohere â€” Tool-Calling-Specification Specification
provider: Cohere
capability: 05-Tool-Use-Function-Calling
file: Tool-Calling-Specification.md
last_updated: 2026-07-28
tags: [cohere, command, rerank, 05-tool-use-function-calling, tool-calling-specification]
author: Antigravity AI Documentation Engine
---

# Cohere â€” Tool-Calling-Specification

## Overview
Detailed technical specification for **Tool-Calling-Specification** under **05-Tool-Use-Function-Calling**.
