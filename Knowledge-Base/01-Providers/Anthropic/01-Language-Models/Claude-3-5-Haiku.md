---
title: Anthropic â€” Claude-3-5-Haiku Specification
provider: Anthropic
capability: 01-Language-Models
file: Claude-3-5-Haiku.md
last_updated: 2026-07-28
tags: [anthropic, claude, 01-language-models, claude-3-5-haiku]
...
## Overview
Detailed technical specification for **Claude-3-5-Haiku** under **01-Language-Models**.
...
print("Executing Claude-3-5-Haiku query...")
`
