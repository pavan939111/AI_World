---
title: Google AI â€” Prompt-Guide Specification
provider: Google AI
capability: 06-Video-Generation
file: Prompt-Guide.md
last_updated: 2026-07-28
tags: [google, deepmind, 06-video-generation, prompt-guide]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Prompt-Guide

## Overview
Detailed technical specification for **Prompt-Guide** under **06-Video-Generation**.
...
client = genai.Client()
print("Executing Prompt-Guide query...")
`
