---
title: PlayHT â€” TTS-Stream-API Specification
provider: PlayHT
capability: 05-PlayHT-API-and-Endpoints
file: TTS-Stream-API.md
last_updated: 2026-07-28
tags: [playht, tts, 05-playht-api-and-endpoints, tts-stream-api]
author: Antigravity AI Documentation Engine
---

# PlayHT â€” TTS-Stream-API

## Overview
Detailed technical specification for **TTS-Stream-API** under **05-PlayHT-API-and-Endpoints**.
