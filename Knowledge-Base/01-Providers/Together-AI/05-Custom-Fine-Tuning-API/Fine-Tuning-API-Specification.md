---
title: Together AI â€” Fine-Tuning-API-Specification Specification
provider: Together AI
capability: 05-Custom-Fine-Tuning-API
file: Fine-Tuning-API-Specification.md
last_updated: 2026-07-28
tags: [together-ai, llama, deepseek, 05-custom-fine-tuning-api, fine-tuning-api-specification]
author: Antigravity AI Documentation Engine
---

# Together AI â€” Fine-Tuning-API-Specification
