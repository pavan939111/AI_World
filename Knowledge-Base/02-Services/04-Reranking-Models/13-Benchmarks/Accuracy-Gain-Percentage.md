---
title: Reranking Models â€” Accuracy-Gain-Percentage
service: 04-Reranking-Models
section: 13-Benchmarks
file: Accuracy-Gain-Percentage.md
last_updated: 2026-07-28
tags: [reranking-models, cross-encoder, ndcg, 13-benchmarks, accuracy-gain-percentage]
author: Antigravity AI Knowledge Engine
---

# Accuracy-Gain-Percentage

## Executive Summary
Detailed technical breakdown of **Accuracy-Gain-Percentage** within the **13-Benchmarks** domain of Cross-Encoder Reranking Models & Two-Stage Information Retrieval.
...
## Detailed Analysis
1. **Technical Foundation**: How Accuracy-Gain-Percentage computes full cross-attention between query and document text to dramatically outperform bi-encoder vector similarity on precision benchmarks.
2. **Production Application**: Best practices for implementing Accuracy-Gain-Percentage in RAG pipelines to eliminate irrelevant context noise and reduce LLM prompt token costs.
