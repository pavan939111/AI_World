---
title: Anthropic â€” TypeScript-SDK Specification
provider: Anthropic
capability: 13-SDKs-and-Developer-Tools
file: TypeScript-SDK.md
last_updated: 2026-07-28
tags: [anthropic, claude, 13-sdks-and-developer-tools, typescript-sdk]
author: Antigravity AI Documentation Engine
---

# Anthropic â€” TypeScript-SDK

## Overview
Detailed technical specification for **TypeScript-SDK** under **13-SDKs-and-Developer-Tools**.
...
print("Executing TypeScript-SDK query...")
`
