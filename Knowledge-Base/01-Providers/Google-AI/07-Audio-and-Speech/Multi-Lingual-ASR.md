---
title: Google AI â€” Multi-Lingual-ASR Specification
provider: Google AI
capability: 07-Audio-and-Speech
file: Multi-Lingual-ASR.md
last_updated: 2026-07-28
tags: [google, deepmind, 07-audio-and-speech, multi-lingual-asr]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Multi-Lingual-ASR

## Overview
Detailed technical specification for **Multi-Lingual-ASR** under **07-Audio-and-Speech**.
...
client = genai.Client()
print("Executing Multi-Lingual-ASR query...")
`
