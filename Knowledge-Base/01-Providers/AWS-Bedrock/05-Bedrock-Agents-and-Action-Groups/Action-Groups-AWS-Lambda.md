---
title: AWS Bedrock â€” Action-Groups-AWS-Lambda Specification
provider: AWS Bedrock
capability: 05-Bedrock-Agents-and-Action-Groups
file: Action-Groups-AWS-Lambda.md
last_updated: 2026-07-28
tags: [aws-bedrock, amazon-nova, claude, 05-bedrock-agents-and-action-groups, action-groups-aws-lambda]
author: Antigravity AI Documentation Engine
---

# AWS Bedrock â€” Action-Groups-AWS-Lambda

## Overview
Detailed technical specification for **Action-Groups-AWS-Lambda** under **05-Bedrock-Agents-and-Action-Groups**.
