---
title: Jina AI â€” Rerank-API Specification
provider: Jina AI
capability: 07-Jina-API-and-Endpoints
file: Rerank-API.md
last_updated: 2026-07-28
tags: [jina-ai, jina-embeddings-v3, 07-jina-api-and-endpoints, rerank-api]
author: Antigravity AI Documentation Engine
---

# Jina AI â€” Rerank-API

## Overview
Detailed technical specification for **Rerank-API** under **07-Jina-API-and-Endpoints**.
