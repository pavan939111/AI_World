---
title: Google AI â€” Whole-Repo-Analysis-2M-Context Specification
provider: Google AI
capability: 09-Code-AI
file: Whole-Repo-Analysis-2M-Context.md
last_updated: 2026-07-28
tags: [google, deepmind, 09-code-ai, whole-repo-analysis-2m-context]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Whole-Repo-Analysis-2M-Context

## Overview
Detailed technical specification for **Whole-Repo-Analysis-2M-Context** under **09-Code-AI**.
...
client = genai.Client()
print("Executing Whole-Repo-Analysis-2M-Context query...")
`
