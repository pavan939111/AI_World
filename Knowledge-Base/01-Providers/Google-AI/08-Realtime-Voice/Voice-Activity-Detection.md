---
title: Google AI â€” Voice-Activity-Detection Specification
provider: Google AI
capability: 08-Realtime-Voice
file: Voice-Activity-Detection.md
last_updated: 2026-07-28
tags: [google, deepmind, 08-realtime-voice, voice-activity-detection]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Voice-Activity-Detection

## Overview
Detailed technical specification for **Voice-Activity-Detection** under **08-Realtime-Voice**.
...
client = genai.Client()
print("Executing Voice-Activity-Detection query...")
`
