---
title: NVIDIA AI â€” Deploying-NIM-Microservice-K8s Specification
provider: NVIDIA
capability: 10-Architectures-and-Examples
file: Deploying-NIM-Microservice-K8s.md
last_updated: 2026-07-28
tags: [nvidia, nim, nemotron, 10-architectures-and-examples, deploying-nim-microservice-k8s]
author: Antigravity AI Documentation Engine
---

# NVIDIA AI â€” Deploying-NIM-Microservice-K8s

## Overview
Detailed technical specification for **Deploying-NIM-Microservice-K8s** under **10-Architectures-and-Examples**.
