---
title: NVIDIA AI â€” TensorRT-LLM-Compiler Specification
provider: NVIDIA
capability: 04-TensorRT-LLM-Inference-Engine
file: TensorRT-LLM-Compiler.md
last_updated: 2026-07-28
tags: [nvidia, nim, nemotron, 04-tensorrt-llm-inference-engine, tensorrt-llm-compiler]
author: Antigravity AI Documentation Engine
---

# NVIDIA AI â€” TensorRT-LLM-Compiler

## Overview
Detailed technical specification for **TensorRT-LLM-Compiler** under **04-TensorRT-LLM-Inference-Engine**.
