---
title: Google AI â€” Imagen-3 Specification
provider: Google AI
capability: 05-Image-Generation
file: Imagen-3.md
last_updated: 2026-07-28
tags: [google, deepmind, 05-image-generation, imagen-3]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Imagen-3

## Overview
Detailed technical specification for **Imagen-3** under **05-Image-Generation**.
...
client = genai.Client()
print("Executing Imagen-3 query...")
`
