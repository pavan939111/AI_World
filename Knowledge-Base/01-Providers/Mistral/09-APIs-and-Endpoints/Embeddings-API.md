---
title: Mistral â€” Embeddings-API Specification
provider: Mistral
capability: 09-APIs-and-Endpoints
file: Embeddings-API.md
last_updated: 2026-07-28
tags: [mistral, moe, 09-apis-and-endpoints, embeddings-api]
author: Antigravity AI Documentation Engine
---

# Mistral â€” Embeddings-API

## Overview
Detailed technical specification for **Embeddings-API** under **09-APIs-and-Endpoints**.
