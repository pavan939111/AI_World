---
title: OpenAI â€” Prompt-Caching-Discounts Specification
provider: OpenAI
capability: 16-Pricing-and-Billing
file: Prompt-Caching-Discounts.md
last_updated: 2026-07-28
tags: [openai, 16-pricing-and-billing, prompt-caching-discounts]
author: Antigravity AI Documentation Engine
---

# OpenAI â€” Prompt-Caching-Discounts

## Overview
Detailed technical specification for **Prompt-Caching-Discounts** under **16-Pricing-and-Billing**.
...
client = OpenAI()
print("Executing Prompt-Caching-Discounts query...")
`
