---
title: Cohere â€” Multi-Step-Enterprise-Agent Specification
provider: Cohere
capability: 14-Architectures-and-Examples
file: Multi-Step-Enterprise-Agent.md
last_updated: 2026-07-28
tags: [cohere, command, rerank, 14-architectures-and-examples, multi-step-enterprise-agent]
author: Antigravity AI Documentation Engine
---

# Cohere â€” Multi-Step-Enterprise-Agent

## Overview
Detailed technical specification for **Multi-Step-Enterprise-Agent** under **14-Architectures-and-Examples**.
