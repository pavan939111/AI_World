---
title: Google AI â€” Whole-Repo-Inspector Specification
provider: Google AI
capability: 22-Architectures-and-Examples
file: Whole-Repo-Inspector.md
last_updated: 2026-07-28
tags: [google, deepmind, 22-architectures-and-examples, whole-repo-inspector]
author: Antigravity AI Documentation Engine
---

# Google AI â€” Whole-Repo-Inspector

## Overview
Detailed technical specification for **Whole-Repo-Inspector** under **22-Architectures-and-Examples**.
...
client = genai.Client()
print("Executing Whole-Repo-Inspector query...")
`
