---
title: Cohere â€” AWS-Bedrock-Integration Specification
provider: Cohere
capability: 10-Multi-Cloud-Deployment
file: AWS-Bedrock-Integration.md
last_updated: 2026-07-28
tags: [cohere, command, rerank, 10-multi-cloud-deployment, aws-bedrock-integration]
author: Antigravity AI Documentation Engine
---

# Cohere â€” AWS-Bedrock-Integration

## Overview
Detailed technical specification for **AWS-Bedrock-Integration** under **10-Multi-Cloud-Deployment**.
