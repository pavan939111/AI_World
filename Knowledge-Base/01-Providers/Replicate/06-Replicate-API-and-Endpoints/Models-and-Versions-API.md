---
title: Replicate â€” Models-and-Versions-API Specification
provider: Replicate
capability: 06-Replicate-API-and-Endpoints
file: Models-and-Versions-API.md
last_updated: 2026-07-28
tags: [replicate, cog, 06-replicate-api-and-endpoints, models-and-versions-api]
author: Antigravity AI Documentation Engine
---

# Replicate â€” Models-and-Versions-API

## Overview
Detailed technical specification for **Models-and-Versions-API** under **06-Replicate-API-and-Endpoints**.
