---
title: AWS Bedrock â€” Converse-API-Specification Specification
provider: AWS Bedrock
capability: 08-APIs-and-Endpoints
file: Converse-API-Specification.md
last_updated: 2026-07-28
tags: [aws-bedrock, amazon-nova, claude, 08-apis-and-endpoints, converse-api-specification]
author: Antigravity AI Documentation Engine
---

# AWS Bedrock â€” Converse-API-Specification

## Overview
Detailed technical specification for **Converse-API-Specification** under **08-APIs-and-Endpoints**.
